...
def IsTaggedUnion {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (union leftTag rightTag left right : ℳ.Domain) : Prop :=
  ∃ leftCopy rightCopy, (∀ pair, ℳ.mem pair leftCopy ↔
      ∃ value, ℳ.mem value left ∧
        𝕀.Codes pair leftTag value) ∧ (∀ pair, ℳ.mem pair rightCopy ↔
