...
def related {parameterCount depth : Nat} (relation : BinarySchema parameterCount) (parameters : TermVector parameterCount depth)
    (left right : Term depth) : Formula 1 depth :=
      ...
      Formula.forallMem target.weaken.weaken <|
        Formula.forallMem target.weaken.weaken.weaken <|
          .imp (.conj (orderedPairMem 𝒞 (.bound 3) (.bound 1)
                function.weaken.weaken.weaken.weaken) (orderedPairMem 𝒞 (.bound 2) (.bound 0)
