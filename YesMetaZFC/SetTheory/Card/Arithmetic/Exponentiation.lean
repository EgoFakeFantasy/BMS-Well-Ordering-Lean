...
theorem eq {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {first second base exponent : ℳ.Domain} (hFirst :
      ℳ.IsCardinalExponentiation 𝕀 first base exponent) (hSecond :
...
/-- `(3.5)`：乘积底数的幂等于两个幂的乘积。 -/
theorem multiplicative_base {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {firstBase secondBase baseProduct exponent
      leftPower firstPower secondPower rightPower : ℳ.Domain} (hBaseProduct :
      ℳ.IsCardinalMultiplication 𝕀
        baseProduct firstBase secondBase) (hLeftPower :
      ℳ.IsCardinalExponentiation 𝕀
        leftPower baseProduct exponent) (hFirstPower :
      ℳ.IsCardinalExponentiation 𝕀
        firstPower firstBase exponent) (hSecondPower :
      ℳ.IsCardinalExponentiation 𝕀
        secondPower secondBase exponent) (hRightPower :
      ℳ.IsCardinalMultiplication 𝕀
  ...
  have hLeftNormalized :=
    ZF.equinumerous_functionSpace hZF 𝕀
      hLeftSpace hNormalizedLeft (Structure.Equinumerous.refl hZF 𝕀 exponentSet)
      hBaseToProduct
  have hSplit :=
  ...
  have hNormalizedFirstToPower :
    ...
    hNormalizedFirstToSpace.trans hZF 𝕀 <| (hFirstPowerCardinal.2.symm hZF 𝕀).trans hZF 𝕀
        hFirstPowerSet.2
  ...
  have hNormalizedSecondToPower :
    ...
    hNormalizedSecondToSpace.trans hZF 𝕀 <| (hSecondPowerCardinal.2.symm hZF 𝕀).trans hZF 𝕀
        hSecondPowerSet.2
...
theorem additive_exponent {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {base firstExponent secondExponent exponentSum
      leftPower firstPower secondPower rightPower : ℳ.Domain} (hExponentSum :
      ℳ.IsCardinalAddition 𝕀
        exponentSum firstExponent secondExponent) (hLeftPower :
      ℳ.IsCardinalExponentiation 𝕀
        leftPower base exponentSum) (hFirstPower :
      ℳ.IsCardinalExponentiation 𝕀
        firstPower base firstExponent) (hSecondPower :
      ℳ.IsCardinalExponentiation 𝕀
        secondPower base secondExponent) (hRightPower :
      ℳ.IsCardinalMultiplication 𝕀
        rightPower firstPower secondPower) :
    leftPower = rightPower := by
  ...
  have hLeftNormalized :=
    ZF.equinumerous_functionSpace hZF 𝕀
      ...
      hExponentSumToUnion (Structure.Equinumerous.refl hZF 𝕀 baseSet)
  have hSplit :=
    ...
    hLeftNormalized.trans hZF 𝕀 <|
      hSplit.trans hZF 𝕀 <|
        hRightNormalized.trans hZF 𝕀 <|
          hRightCardinal.2.symm hZF 𝕀
/-- `(3.7)`：幂的幂等于以指数乘积为指数的幂。 -/
theorem iterated_exponent {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {base firstExponent secondExponent innerPower
      leftPower exponentProduct rightPower : ℳ.Domain} (hInnerPower :
      ℳ.IsCardinalExponentiation 𝕀
        innerPower base firstExponent) (hLeftPower :
      ℳ.IsCardinalExponentiation 𝕀
        leftPower innerPower secondExponent) (hExponentProduct :
      ℳ.IsCardinalMultiplication 𝕀
        exponentProduct firstExponent secondExponent) (hRightPower :
      ℳ.IsCardinalExponentiation 𝕀
  ...
  have hLeftNormalized :=
    ZF.equinumerous_functionSpace hZF 𝕀
      hLeftSpace hNormalizedLeft (Structure.Equinumerous.refl hZF 𝕀 secondExponentSet)
      hLeftBaseToInner
  have hCurry :=
  ...
  have hProductToRightExponent :
    ...
    hProductEquinumerous.trans hZF 𝕀 <| (hExponentProductCardinal.2.symm hZF 𝕀).trans hZF 𝕀
        hRightExponentSet.2
  have hBaseEquinumerous :
...
theorem monotone_base {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {firstPower secondPower firstBase secondBase exponent : ℳ.Domain} (hBase :
      ℳ.CardinalLessOrEqual 𝕀 firstBase secondBase) (hFirst :
      ℳ.IsCardinalExponentiation 𝕀
        firstPower firstBase exponent) (hSecond :
      ℳ.IsCardinalExponentiation 𝕀
...
theorem monotone_exponent_of_nonempty {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {firstPower secondPower base firstExponent secondExponent : ℳ.Domain} (hFirstExponentNonempty :
      ∃ value, ℳ.mem value firstExponent) (hExponent :
      ℳ.CardinalLessOrEqual 𝕀 firstExponent secondExponent) (hFirst :
      ℳ.IsCardinalExponentiation 𝕀
        firstPower base firstExponent) (hSecond :
      ℳ.IsCardinalExponentiation 𝕀
  ...
  exact ZF.exists_compositionInjection hZF 𝕀
    hToSecondSpace hSecondPowerMap.1
/-- `(3.10)`：任意基数的零次幂等于一。 -/
theorem zero_exponent {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {power base zero one zeroSet oneSet oneValue : ℳ.Domain} (hZero : ℳ.IsCardinalOf 𝕀 zero zeroSet) (hZeroSet : ∀ value, ¬ ℳ.mem value zeroSet)
    (hOne : ℳ.IsCardinalOf 𝕀 one oneSet) (hOneSet : ℳ.IsSingletonOf oneSet oneValue) (hPower :
  ...
  exact hResult.2.trans hZF 𝕀 <|
    hSpaceToOneSet.trans hZF 𝕀 <|
      hOne.2.symm hZF 𝕀
/-- `(3.10)`：一的任意基数次幂仍等于一。 -/
theorem one_base {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {power exponent one oneSet oneValue : ℳ.Domain} (hOne : ℳ.IsCardinalOf 𝕀 one oneSet) (hOneSet : ℳ.IsSingletonOf oneSet oneValue) (hPower :
  ...
  have hSpaceToNormalized :=
    ZF.equinumerous_functionSpace hZF 𝕀
      hSpace hNormalizedSpace (Structure.Equinumerous.refl hZF 𝕀 exponentSet)
      hBaseToOneSet
...
theorem zero_base_of_nonempty_exponent {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {power exponent zero zeroSet : ℳ.Domain} (hExponentNonempty : ∃ value, ℳ.mem value exponent) (hZero : ℳ.IsCardinalOf 𝕀 zero zeroSet)
    (hZeroSet : ∀ value, ¬ ℳ.mem value zeroSet) (hPower :
