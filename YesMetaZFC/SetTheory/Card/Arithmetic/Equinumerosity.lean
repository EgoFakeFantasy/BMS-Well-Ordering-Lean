...
的位置。
-/
def ordinalMultiplicationValue (𝒞 : OrderedPairConvention) : BinarySchema 1 where
...
def successorAbsorptionValue : BinarySchema 3 where
  body := .disj (.conj (Formula.extensionalEq (.bound 1) (.bound 2)) (Formula.extensionalEq (.bound 0) (.bound 4))) <|
...
def associateTaggedUnionValue (𝒞 : OrderedPairConvention) : BinarySchema 2 where
  body := .disj (.existsE <| .existsE <|
      ...
      .conj (𝒞.code (.bound 1) (.bound 4) (.bound 0)) (𝒞.code (.bound 2) (.bound 4) (.bound 0))) <|
    .disj (.existsE <| .existsE <| .existsE <|
...
theorem denote_disjointUnionValue_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (env : Env ℳ 4) (input output : ℳ.Domain) :
    (BinarySchema.disjointUnionValue 𝒞).denote env input output ↔ (ℳ.mem input (env.bound 2) ∧
        ℳ.PairMember 𝕀 input output (env.bound 0)) ∨ (ℳ.mem input (env.bound 3) ∧
...
theorem denote_ordinalMultiplicationValue_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ) (env : Env ℳ 1) (input output : ℳ.Domain) :
...
theorem denote_successorAbsorptionValue_iff
    {ℳ : Structure.{u}} (hExt : Extensional ℳ) (env : Env ℳ 3) (input output : ℳ.Domain) :
    BinarySchema.successorAbsorptionValue.denote env input output ↔ (input = env.bound 0 ∧ output = env.bound 2) ∨ (ℳ.mem input (env.bound 1) ∧
        ℳ.SuccessorOf output input) ∨ (input ≠ env.bound 0 ∧
  ...
  change ((input = env.bound 0 ∧ output = env.bound 2) ∨ (ℳ.mem input (env.bound 1) ∧
        ℳ.SuccessorOf output input) ∨ (input ≠ env.bound 0 ∧
...
theorem denote_associateCartesianProductValue_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (env : Env ℳ 0) (input output : ℳ.Domain) :
...
theorem denote_associateTaggedUnionValue_iff
    ...
    (BinarySchema.associateTaggedUnionValue 𝒞).denote
        env input output ↔ (∃ inner value,
        𝕀.Codes input (env.bound 0) inner ∧
          𝕀.Codes inner (env.bound 0) value ∧
          𝕀.Codes output (env.bound 0) value) ∨ (∃ inner value innerOutput,
        𝕀.Codes input (env.bound 0) inner ∧
          𝕀.Codes inner (env.bound 1) value ∧
          𝕀.Codes innerOutput (env.bound 0) value ∧
          𝕀.Codes output (env.bound 1) innerOutput) ∨ (∃ value innerOutput,
...
theorem equinumerous_unionOfTwo
    ...
    {source target sourceLeft sourceRight targetLeft targetRight
      leftFunction rightFunction : ℳ.Domain} (hSourceUnion :
      ℳ.IsUnionOfTwo source sourceLeft sourceRight) (hTargetUnion :
      ℳ.IsUnionOfTwo target targetLeft targetRight) (hSourceDisjoint :
      ℳ.IsDisjoint sourceLeft sourceRight) (hTargetDisjoint :
      ℳ.IsDisjoint targetLeft targetRight) (hLeft :
      ℳ.IsSetBijectionFromTo 𝕀
        leftFunction sourceLeft targetLeft) (hRight :
      ℳ.IsSetBijectionFromTo 𝕀
  ...
  · intro input hInput
    ...
    · rcases hLeft.1.1.2.2 input hInputLeft with
        ⟨output, _, hPair⟩
      exact ⟨output, (Definitional.Project.Formula.denote_disjointUnionValue_iff
  ...
  · intro output hOutput
    ...
    · rcases hLeft.2 output hOutputLeft with
        ⟨input, hInput, hPair⟩
      exact ⟨input, (hSourceUnion input).mpr <| Or.inl hInput, (Definitional.Project.Formula.denote_disjointUnionValue_iff
          𝕀 env input output).mpr <|
          Or.inl ⟨hInput, hPair⟩⟩
    · rcases hRight.2 output hOutputRight with
        ⟨input, hInput, hPair⟩
      exact ⟨input, (hSourceUnion input).mpr <| Or.inr hInput, (Definitional.Project.Formula.denote_disjointUnionValue_iff
          𝕀 env input output).mpr <|
          Or.inr ⟨hInput, hPair⟩⟩
/-- 固定标签的有序对行与原集合等势。 -/
theorem equinumerous_cartesianRow
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {tag set row : ℳ.Domain} (hRow : ∀ pair, ℳ.mem pair row ↔
  ...
  · intro input _
    ...
    exact ⟨pair, (Definitional.Project.Formula.denote_orderedPairWithLeft_iff
  ...
  · intro pair hPair
    ...
    exact ⟨value, hValue, (Definitional.Project.Formula.denote_orderedPairWithLeft_iff
...
theorem equinumerous_unionToTaggedUnion
    ...
    {source sourceLeft sourceRight target
      leftTag rightTag targetLeft targetRight : ℳ.Domain} (hSourceUnion :
      ℳ.IsUnionOfTwo source sourceLeft sourceRight) (hSourceDisjoint :
      ℳ.IsDisjoint sourceLeft sourceRight) (hTarget :
      ℳ.IsTaggedUnion 𝕀
        target leftTag rightTag targetLeft targetRight) (hLeft :
      ℳ.Equinumerous 𝕀 sourceLeft targetLeft) (hRight :
...
theorem exists_cartesianProductInjection
    ...
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {source target sourceLeft sourceRight targetLeft targetRight
      leftFunction rightFunction : ℳ.Domain} (hSourceProduct :
      ℳ.IsCartesianProduct 𝕀 source sourceLeft sourceRight) (hTargetProduct :
      ℳ.IsCartesianProduct 𝕀 target targetLeft targetRight) (hLeft :
  ...
  · intro input hInput
    ...
    rcases 𝕀.total targetLeftValue targetRightValue with
      ⟨output, hOutputCode⟩
    exact ⟨output, (Definitional.Project.Formula.denote_cartesianProductValue_iff
        𝕀 env input output).mpr
...
theorem equinumerous_cartesianProduct
  ...
  · intro output hOutput
    ...
    rcases 𝕀.total sourceLeftValue sourceRightValue with
      ⟨input, hInputCode⟩
    exact ⟨input, (hSourceProduct input).mpr
        ⟨sourceLeftValue, hSourceLeft,
          sourceRightValue, hSourceRight, hInputCode⟩, (Definitional.Project.Formula.denote_cartesianProductValue_iff
        𝕀 env input output).mpr
          ⟨sourceLeftValue, sourceRightValue,
            targetLeftValue, targetRightValue,
            hInputCode, hLeftPair, hRightPair, hOutputCode⟩⟩
...
theorem equinumerous_cartesianProduct_ordinalMultiplication
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {left right cartesian product : ℳ.Domain} (hLeft : ℳ.IsOrdinal left) (hRight : ℳ.IsOrdinal right) (hCartesian :
      ℳ.IsCartesianProduct 𝕀 cartesian left right) (hProduct :
  ...
  have coordinates_mem
      {input leftValue rightValue : ℳ.Domain} (hInput : ℳ.mem input cartesian) (hCode : 𝕀.Codes input leftValue rightValue) :
  ...
  apply exists_setBijectionFromTo_of_denote
      hZF 𝕀 (Definitional.Project.BinarySchema.ordinalMultiplicationValue 𝒞)
        env
  · intro input hInput
    rcases (hCartesian input).mp hInput with
    ...
    rcases ordinalAddition_existsUnique
      ...
      ⟨output, hOutput, _⟩
    exact ⟨output, (Definitional.Project.Formula.denote_ordinalMultiplicationValue_iff
  ...
  · intro input hInput first second hFirst hSecond
    ...
    rcases ordinalAddition_existsUnique
      ...
      ⟨selected, _, hUnique⟩
    exact (hUnique first hFirstValue).trans (hUnique second hSecondValue).symm
  ...
  · intro first second output hFirstInput hSecondInput
    ...
    have hCoordinateEq :=
      ordinalMultiplication_block_coordinates_unique
        hZF 𝕀 hLeft hLeftNonempty (hRight.mem hFirstCoordinates.2) (hRight.mem hSecondCoordinates.2)
  ...
  · intro output hOutput
    ...
    rcases 𝕀.total leftValue rightValue with
      ⟨input, hInputCode⟩
    exact ⟨input, (hCartesian input).mpr
        ⟨leftValue, hLeftValue,
          rightValue, hRightValue, hInputCode⟩, (Definitional.Project.Formula.denote_ordinalMultiplicationValue_iff
        𝕀 hZF.1 env input output).mpr
          ⟨leftValue, rightValue, block,
...
theorem equinumerous_successor_of_omegaSubset
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {ω set successor : ℳ.Domain} (hω : ℳ.IsOmega ω) (hOmegaSubset : ℳ.MemberSubset ω set) (hSuccessor : ℳ.SuccessorOf successor set) :
  ...
  have hSetNotOmega : ¬ ℳ.mem set ω := by
    intro hSetOmega
    exact KP.mem_irrefl_d (ZF.modelsKP hZF) set <|
  ...
  have hValueSemantic (input output : ℳ.Domain) :
      Definitional.Project.BinarySchema.successorAbsorptionValue.denote
          env input output ↔ (input = set ∧ output = zero) ∨ (ℳ.mem input ω ∧ ℳ.SuccessorOf output input) ∨
    ...
    change ((input = set ∧ output = zero) ∨ (ℳ.mem input ω ∧ ℳ.SuccessorOf output input) ∨ (input ≠ set ∧ ¬ ℳ.mem input ω ∧ output = input)) ↔ _
    rfl
  have hSuccessorToSet :
    ...
    · intro first second output hFirstInput hSecondInput
      ...
      · rcases hSecond with hSecondExtra | hSecondNatural | hSecondFixed
        ...
        · exact Structure.SuccessorOf.predecessor_eq hZF.1 (hω.members_areOrdinals hZF first hFirstNatural.1)
            hFirstNatural.2 hSecondNatural.2
...
theorem equinumerous_productOverTaggedUnion
    ...
    {left rightLeft rightRight rightUnion source
      leftProduct rightProduct target leftTag rightTag : ℳ.Domain} (hRightUnion :
      ℳ.IsTaggedUnion 𝕀
        rightUnion leftTag rightTag rightLeft rightRight) (hSource :
      ℳ.IsCartesianProduct 𝕀 source left rightUnion) (hLeftProduct :
      ℳ.IsCartesianProduct 𝕀 leftProduct left rightLeft) (hRightProduct :
      ℳ.IsCartesianProduct 𝕀 rightProduct left rightRight) (hTarget :
      ℳ.IsTaggedUnion 𝕀
  ...
  have hRightLeftEquinumerous := (equinumerous_cartesianRow hZF 𝕀
      hRightLeftCopy).symm hZF 𝕀
  have hRightRightEquinumerous := (equinumerous_cartesianRow hZF 𝕀
...
theorem equinumerous_swappedCartesianProduct
    ...
    {source target sourceLeft sourceRight targetLeft targetRight
      ...
      ℳ.IsCartesianProduct 𝕀 target targetLeft targetRight) (hLeft :
      ℳ.IsSetBijectionFromTo 𝕀
        leftFunction sourceLeft targetRight) (hRight :
      ℳ.IsSetBijectionFromTo 𝕀
  ...
  apply exists_setBijectionFromTo_of_denote
      hZF 𝕀 (Definitional.Project.BinarySchema.swappedCartesianProductValue 𝒞) env
  · intro input hInput
    rcases (hSourceProduct input).mp hInput with
      ⟨sourceLeftValue, hSourceLeft,
        sourceRightValue, hSourceRight, hInputCode⟩
    ...
    rcases 𝕀.total targetLeftValue targetRightValue with
      ⟨output, hOutputCode⟩
    exact ⟨output, (Definitional.Project.Formula.denote_swappedCartesianProductValue_iff
        𝕀 env input output).mpr
          ⟨sourceLeftValue, sourceRightValue,
            targetLeftValue, targetRightValue,
            hInputCode, hLeftPair, hRightPair, hOutputCode⟩⟩
  ...
  · intro output hOutput
    ...
    exact ⟨input, (hSourceProduct input).mpr
        ⟨sourceLeftValue, hSourceLeft,
          sourceRightValue, hSourceRight, hInputCode⟩, (Definitional.Project.Formula.denote_swappedCartesianProductValue_iff
        𝕀 env input output).mpr
          ⟨sourceLeftValue, sourceRightValue,
            targetLeftValue, targetRightValue,
            hInputCode, hLeftPair, hRightPair, hOutputCode⟩⟩
...
theorem equinumerous_functionSpace
    ...
    {sourceSpace targetSpace sourceDomain sourceBase
      targetDomain targetBase : ℳ.Domain} (hSourceSpace :
      ℳ.IsFunctionSpace 𝕀 sourceSpace sourceDomain sourceBase) (hTargetSpace :
      ℳ.IsFunctionSpace 𝕀 targetSpace targetDomain targetBase) (hDomain :
      ℳ.Equinumerous 𝕀 sourceDomain targetDomain) (hBase :
...
theorem equinumerous_associatedCartesianProduct
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {left middle right leftProduct source rightProduct target : ℳ.Domain} (hLeftProduct :
      ℳ.IsCartesianProduct 𝕀 leftProduct left middle) (hSource :
      ℳ.IsCartesianProduct 𝕀 source leftProduct right) (hRightProduct :
      ℳ.IsCartesianProduct 𝕀 rightProduct middle right) (hTarget :
  ...
  apply exists_setBijectionFromTo_of_denote
      hZF 𝕀 (Definitional.Project.BinarySchema.associateCartesianProductValue 𝒞) env
  · intro input hInput
    ...
    rcases 𝕀.total leftValue rightPair with
      ⟨output, hOutputCode⟩
    exact ⟨output, (Definitional.Project.Formula.denote_associateCartesianProductValue_iff
        𝕀 env input output).mpr
  ...
  · intro input output hInput hValue
    ...
    exact ⟨leftValue,
      hSourceLeft,
      rightPair, (hRightProduct rightPair).mpr
  ...
  · intro output hOutput
    ...
    rcases 𝕀.total leftPair rightValue with
      ⟨input, hInputCode⟩
    exact ⟨input, (hSource input).mpr
        ⟨leftPair, (hLeftProduct leftPair).mpr
            ⟨leftValue, hLeft,
              middleValue, hMiddle, hLeftCode⟩,
          rightValue, hRight, hInputCode⟩, (Definitional.Project.Formula.denote_associateCartesianProductValue_iff
        𝕀 env input output).mpr
          ⟨leftValue, middleValue, rightValue,
            leftPair, rightPair,
            hLeftCode, hInputCode, hRightCode, hOutputCode⟩⟩
...
theorem equinumerous_associatedTaggedUnion
    ...
    {leftTag rightTag left middle right
      leftMiddle source middleRight target : ℳ.Domain} (hTags : leftTag ≠ rightTag) (hLeftMiddle :
      ℳ.IsTaggedUnion 𝕀
        leftMiddle leftTag rightTag left middle) (hSource :
      ℳ.IsTaggedUnion 𝕀
        source leftTag rightTag leftMiddle right) (hMiddleRight :
      ℳ.IsTaggedUnion 𝕀
        middleRight leftTag rightTag middle right) (hTarget :
      ℳ.IsTaggedUnion 𝕀
  ...
  apply exists_setBijectionFromTo_of_denote
      hZF 𝕀 (Definitional.Project.BinarySchema.associateTaggedUnionValue 𝒞) env
  · intro input hInput
    ...
    · rcases (hSourceLeft input).mp hInputLeft with
      ...
      · rcases (hLeftCopy inner).mp hInnerLeft with
        ...
        exact ⟨output, (Definitional.Project.Formula.denote_associateTaggedUnionValue_iff
            𝕀 env input output).mpr <|
              Or.inl ⟨inner, value,
  ...
  · intro input _ first second hFirst hSecond
    ...
    · rcases hSecond with hSecondLeft | hSecondMiddle | hSecondRight
      ...
      · rcases hFirstLeft with
        ...
        subst secondInner
        exact False.elim <| hTags <| (𝕀.injective hFirstInner hSecondInner).1
      · rcases hFirstLeft with
          ⟨_, _, hFirstInput, _, _⟩
        rcases hSecondRight with
          ⟨_, _, hSecondInput, _, _⟩
        exact False.elim <| hTags <| (𝕀.injective hFirstInput hSecondInput).1
    · rcases hSecond with hSecondLeft | hSecondMiddle | hSecondRight
      · rcases hFirstMiddle with
        ...
        have hInnerEq := (𝕀.injective hFirstInput hSecondInput).2
        subst secondInner
        exact False.elim <| hTags <| (𝕀.injective hSecondInner hFirstInner).1
      · rcases hFirstMiddle with
    ...
    · rcases hSecond with hSecondLeft | hSecondMiddle | hSecondRight
      · rcases hFirstRight with
        ...
        rcases hSecondLeft with
          ⟨_, _, hSecondInput, _, _⟩
        exact False.elim <| hTags <| (𝕀.injective hSecondInput hFirstInput).1
      · rcases hFirstRight with
          ⟨_, _, hFirstInput, _, _⟩
        rcases hSecondMiddle with
  ...
  · intro input output hInput hValue
    ...
    · rcases (hSourceLeft input).mp hInputLeft with
      ...
      · rcases (hLeftCopy sourceInner).mp hSourceInnerLeft with
        ...
        · rcases hLeft with
          ...
          subst sourceValue
          exact (hTargetUnion output).mpr <| Or.inl <| (hTargetLeft output).mpr
              ⟨value, hSourceValue, hOutputCode⟩
        · rcases hMiddle with
            ⟨inner, _, _, hInputCode, hInnerCode, _, _⟩
          have hInnerEq := (𝕀.injective hInputCode hSourceInputCode).2
          subst sourceInner
          exact False.elim <| hTags <| (𝕀.injective hSourceInnerCode hInnerCode).1
        · rcases hRight with
            ⟨_, _, hInputCode, _, _⟩
          exact False.elim <| hTags <| (𝕀.injective hSourceInputCode hInputCode).1
      · rcases (hMiddleCopy sourceInner).mp hSourceInnerMiddle with
        ...
        · rcases hLeft with
          ...
          have hInnerEq := (𝕀.injective hInputCode hSourceInputCode).2
          subst sourceInner
          exact False.elim <| hTags <| (𝕀.injective hInnerCode hSourceInnerCode).1
        · rcases hMiddle with
            ⟨inner, value, innerOutput,
              hInputCode, hInnerCode,
              hInnerOutputCode, hOutputCode⟩
          ...
          have hValueEq := (𝕀.injective hInnerCode hSourceInnerCode).2
          subst sourceValue
          exact (hTargetUnion output).mpr <| Or.inr <| (hTargetRight output).mpr
              ⟨innerOutput, (hMiddleRightUnion innerOutput).mpr <| Or.inl <| (hMiddleCopy' innerOutput).mpr
    ...
    · rcases (hSourceRight input).mp hInputRight with
      ...
      · rcases hLeft with
          ⟨_, _, hInputCode, _, _⟩
        exact False.elim <| hTags <| (𝕀.injective hInputCode hSourceInputCode).1
      · rcases hMiddle with
      ...
      · rcases hRight with
        ...
        subst sourceValue
        exact (hTargetUnion output).mpr <| Or.inr <| (hTargetRight output).mpr
            ⟨innerOutput, (hMiddleRightUnion innerOutput).mpr <| Or.inr <| (hRightCopy innerOutput).mpr
                  ⟨value, hSourceValue, hInnerOutputCode⟩,
              hOutputCode⟩
  · intro first second output _ _ hFirst hSecond
    rw [Definitional.Project.Formula.denote_associateTaggedUnionValue_iff 𝕀]
    ...
    · rcases hSecond with hSecondLeft | hSecondMiddle | hSecondRight
      ...
      · rcases hFirstLeft with
        ...
        exact False.elim <| hTags <| (𝕀.injective hFirstOutput hSecondOutput).1
      · rcases hFirstLeft with
          ⟨_, _, _, _, hFirstOutput⟩
        rcases hSecondRight with
    ...
    · rcases hSecond with hSecondLeft | hSecondMiddle | hSecondRight
      · rcases hFirstMiddle with
        ...
        rcases hSecondLeft with
          ⟨_, _, _, _, hSecondOutput⟩
        exact False.elim <| hTags <| (𝕀.injective hSecondOutput hFirstOutput).1
      · rcases hFirstMiddle with
          ⟨firstInner, firstValue, firstInnerOutput,
            hFirstInput, hFirstInner,
            hFirstInnerOutput, hFirstOutput⟩
        rcases hSecondMiddle with
          ⟨secondInner, secondValue, secondInnerOutput,
            hSecondInput, hSecondInner,
            hSecondInnerOutput, hSecondOutput⟩
        have hInnerOutputEq := (𝕀.injective hFirstOutput hSecondOutput).2
        subst secondInnerOutput
        have hValueEq := (𝕀.injective hFirstInnerOutput hSecondInnerOutput).2
        subst secondValue
        have hInnerEq := 𝕀.unique hFirstInner hSecondInner
        subst secondInner
        exact 𝕀.unique hFirstInput hSecondInput
      · rcases hFirstMiddle with
        ...
        have hInnerOutputEq := (𝕀.injective hFirstOutput hSecondOutput).2
        subst secondInnerOutput
        exact False.elim <| hTags <| (𝕀.injective hFirstInnerOutput hSecondInnerOutput).1
    · rcases hSecond with hSecondLeft | hSecondMiddle | hSecondRight
      · rcases hFirstRight with
          ⟨_, _, _, _, hFirstOutput⟩
        rcases hSecondLeft with
      ...
      · rcases hFirstRight with
        ...
        have hInnerOutputEq := (𝕀.injective hFirstOutput hSecondOutput).2
        subst secondInnerOutput
        exact False.elim <| hTags <| (𝕀.injective hSecondInnerOutput hFirstInnerOutput).1
      · rcases hFirstRight with
          ⟨firstValue, firstInnerOutput,
            hFirstInput, hFirstInnerOutput, hFirstOutput⟩
        rcases hSecondRight with
  ...
  · intro output hOutput
    ...
    · rcases (hTargetLeft output).mp hOutputLeft with
      ...
      exact ⟨input, (hSourceUnion input).mpr <| Or.inl <| (hSourceLeft input).mpr
            ⟨inner, (hLeftMiddleUnion inner).mpr <| Or.inl <| (hLeftCopy inner).mpr
                  ⟨value, hValue, hInnerCode⟩,
              hInputCode⟩, (Definitional.Project.Formula.denote_associateTaggedUnionValue_iff
    ...
    · rcases (hTargetRight output).mp hOutputRight with
      ...
      · rcases (hMiddleCopy' innerOutput).mp hInnerOutputMiddle with
        ...
        rcases 𝕀.total leftTag inner with ⟨input, hInputCode⟩
        exact ⟨input, (hSourceUnion input).mpr <| Or.inl <| (hSourceLeft input).mpr
              ⟨inner, (hLeftMiddleUnion inner).mpr <| Or.inr <| (hMiddleCopy inner).mpr
                    ⟨value, hValue, hInnerCode⟩,
                hInputCode⟩, (Definitional.Project.Formula.denote_associateTaggedUnionValue_iff
      ...
      · rcases (hRightCopy innerOutput).mp hInnerOutputRight with
        ...
        exact ⟨input, (hSourceUnion input).mpr <| Or.inr <| (hSourceRight input).mpr
              ⟨value, hValue, hInputCode⟩, (Definitional.Project.Formula.denote_associateTaggedUnionValue_iff
