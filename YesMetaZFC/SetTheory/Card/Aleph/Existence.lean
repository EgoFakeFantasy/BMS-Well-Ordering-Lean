...
theorem isCardinal_of_members
    ...
    {supremum family : ℳ.Domain} (hUnion : ℳ.IsUnionOf supremum family) (hCardinals :
  ...
  have hκToβInjection :
    ...
    exact hSupremumToβ.1.2 first second output ((hκToβRestriction.2 first output).mp hFirst).2 ((hκToβRestriction.2 second output).mp hSecond).2
