...
private partial def compileTerm (binders : List Binder) (binderDepth : Nat) (termSyntax : Syntax) : TermElabM Syntax := do
...
mutual
private partial def compileFormula (binders : List Binder) (binderDepth : Nat) (formulaSyntax : Syntax) : TermElabM Syntax := do
  ...
  | `(setFormula| $element:setTerm ∈ ⋃ $family:setTerm) =>
      ...
      `(SetTheory.Definitional.Project.Formula.existsMem $(asTerm family) (SetTheory.Definitional.Formula.mem
  ...
  | `(setFormula| $element:setTerm ∈ ($left:setTerm ∩ $right:setTerm)) =>
      let element ← compileTerm binders binderDepth element
      let left ← compileTerm binders binderDepth left
      let right ← compileTerm binders binderDepth right
      `(SetTheory.Definitional.Formula.conj (SetTheory.Definitional.Formula.mem $(asTerm element) $(asTerm left))
          (SetTheory.Definitional.Formula.mem $(asTerm element) $(asTerm right)))
  | `(setFormula| $element:setTerm ∈ ($left:setTerm ∖ $right:setTerm)) =>
      let element ← compileTerm binders binderDepth element
      let left ← compileTerm binders binderDepth left
      let right ← compileTerm binders binderDepth right
      `(SetTheory.Definitional.Formula.conj (SetTheory.Definitional.Formula.mem $(asTerm element) $(asTerm left)) (SetTheory.Definitional.Formula.neg
            (SetTheory.Definitional.Formula.mem $(asTerm element) $(asTerm right))))
  ...
  | `(setFormula| $left:setTerm ∉ $right:setTerm) =>
      let left ← compileTerm binders binderDepth left
      let right ← compileTerm binders binderDepth right
      `(SetTheory.Definitional.Formula.neg (SetTheory.Definitional.Formula.mem $(asTerm left) $(asTerm right)))
  | `(setFormula| $left:setTerm = $right:setTerm) =>
      let left ← compileTerm binders binderDepth left
      let right ← compileTerm binders binderDepth right
  ...
  | `(setFormula| ∀ $identifiers:ident* , $body:setFormula) =>
      compileQuantifier true binders binderDepth (identifiers.toList.map (·.raw)) body
  | `(setFormula| ∃ $identifiers:ident* , $body:setFormula) =>
      compileQuantifier false binders binderDepth (identifiers.toList.map (·.raw)) body
...
private partial def compileUnderBinder (binders : List Binder) (binderDepth : Nat) (identifier : Syntax) (body : Syntax) : TermElabM Syntax := do
...
private partial def compileQuantifier (universal : Bool) (binders : List Binder) (binderDepth : Nat) (identifiers : List Syntax) (body : Syntax) :
    TermElabM Syntax := do
...
elab (name := elaborateSetTheorySentence)
  ...
  let compiledTerm : TSyntax `term := ⟨compiled⟩
  let result ←
    `((SetTheory.Definitional.Project.Sentence.ofFormula ($compiledTerm : SetTheory.Definitional.Project.OpenFormula)
        (by native_decide) : SetTheory.Definitional.Project.Sentence))
  elabTerm result none
private def elaborateClass (depth : Syntax) (identifier : Syntax) (body : Syntax) : TermElabM Expr := do
