...
def IsFunctionDomainSplit {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (left right input output : ℳ.Domain) : Prop :=
...
def IsLeftFunctionProjection {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (function input source left : ℳ.Domain) : Prop :=
...
def IsRightFunctionProjection {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (function input source right : ℳ.Domain) : Prop :=
...
def IsFunctionCodomainSplit {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (source left right input output : ℳ.Domain) : Prop :=
  ∃ leftFunction rightFunction,
...
def IsFunctionSection {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (sectionFunction flat left base rightValue : ℳ.Domain) : Prop :=
...
def IsFunctionUncurrying {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (input output product base : ℳ.Domain) : Prop :=
...
/-- 把目标集中的一个值映为相应的常值函数。 -/
def constantFunctionValue (𝒞 : OrderedPairConvention) : BinarySchema 2 where
...
namespace Formula
/-- 左坐标投影函数的对象语言刻画。 -/
def isLeftFunctionProjection (𝒞 : OrderedPairConvention) {depth : Nat} (function input source left : Term depth) : Formula 1 depth :=
...
def isFunctionUncurrying (𝒞 : OrderedPairConvention) {depth : Nat} (input output product base : Term depth) : Formula 1 depth :=
  .conj (isFunctionFromTo 𝒞 output product base) <|
    .forallE <| .forallE <| .iff (orderedPairMem 𝒞 (.bound 1) (.bound 0) output.weaken.weaken) <|
...
namespace BinarySchema
/-- 把左右投影函数编码为输出有序对。 -/
def splitFunctionCodomainValue (𝒞 : OrderedPairConvention) : BinarySchema 3 where
  body := .existsE <| .existsE <|
...
namespace Formula
/-- 常值函数族映射模式的纸面解释。 -/
theorem denote_constantFunctionValue_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ) (env : Env ℳ 2) (input output : ℳ.Domain) :
    (BinarySchema.constantFunctionValue 𝒞).denote
        env input output ↔
      ℳ.IsSetFunctionFromTo 𝕀
          output (env.bound 0) (env.bound 1) ∧
        ∀ argument value,
          ℳ.PairMember 𝕀 argument value output ↔
            ℳ.mem argument (env.bound 0) ∧
              value = input := by
  simp only [BinarySchema.constantFunctionValue,
  ...
  rfl
/-- 函数族固定坐标求值模式的纸面解释。 -/
theorem denote_familyEvaluationValue_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (env : Env ℳ 2) (row output : ℳ.Domain) :
    (BinarySchema.familyEvaluationValue 𝒞).denote
        env row output ↔
      ∃ function,
        ℳ.PairMember 𝕀 row function (env.bound 0) ∧
          ℳ.PairMember 𝕀 (env.bound 1) output function := by
  simp only [BinarySchema.familyEvaluationValue,
    BinarySchema.denote, satisfies_exists_iff,
    satisfies_conj_iff, satisfies_orderedPairMem_iff 𝕀,
    Term.eval_bound_zero_push, Term.eval_bound_one_push,
    Term.eval_bound_two_push, Term.eval_bound_three_push,
    Term.eval_bound_four_push]
  rfl
...
theorem denote_leftFunctionProjectionValue_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (env : Env ℳ 1) (argument output : ℳ.Domain) :
...
theorem denote_combineFunctionCoordinatesValue_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (env : Env ℳ 2) (argument output : ℳ.Domain) :
...
theorem denote_uncurriedFunctionValue_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (env : Env ℳ 1) (productValue output : ℳ.Domain) :
...
theorem denote_functionSectionValue_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (env : Env ℳ 2) (leftValue output : ℳ.Domain) :
...
theorem satisfies_isFunctionSection_iff
    ...
    {depth : Nat} (env : Env ℳ depth) (sectionFunction flat left base rightValue : Term depth) :
    satisfies env (isFunctionSection 𝒞 sectionFunction flat left base rightValue) ↔
      ℳ.IsFunctionSection 𝕀 (sectionFunction.eval env) (flat.eval env) (left.eval env) (base.eval env) (rightValue.eval env) := by
...
theorem satisfies_isFunctionUncurrying_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ)
    {depth : Nat} (env : Env ℳ depth) (input output product base : Term depth) :
    satisfies env (isFunctionUncurrying 𝒞 input output product base) ↔
      ℳ.IsFunctionUncurrying 𝕀 (input.eval env) (output.eval env) (product.eval env) (base.eval env) := by
...
theorem denote_functionSection_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ) (env : Env ℳ 3) (rightValue sectionFunction : ℳ.Domain) :
    (BinarySchema.functionSection 𝒞).denote
        env rightValue sectionFunction ↔
      ℳ.IsFunctionSection 𝕀
        sectionFunction (env.bound 0) (env.bound 1) (env.bound 2) rightValue := by
...
theorem satisfies_isLeftFunctionProjection_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ)
    {depth : Nat} (env : Env ℳ depth) (function input source left : Term depth) :
    satisfies env (isLeftFunctionProjection 𝒞 function input source left) ↔
      ℳ.IsLeftFunctionProjection 𝕀 (function.eval env) (input.eval env) (source.eval env) (left.eval env) := by
...
theorem satisfies_isRightFunctionProjection_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ)
    {depth : Nat} (env : Env ℳ depth) (function input source right : Term depth) :
    satisfies env (isRightFunctionProjection 𝒞 function input source right) ↔
      ℳ.IsRightFunctionProjection 𝕀 (function.eval env) (input.eval env) (source.eval env) (right.eval env) := by
...
theorem denote_splitFunctionCodomainValue_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ) (env : Env ℳ 3) (input output : ℳ.Domain) :
    (BinarySchema.splitFunctionCodomainValue 𝒞).denote
        env input output ↔
      ℳ.IsFunctionCodomainSplit 𝕀 (env.bound 0) (env.bound 1) (env.bound 2)
        input output := by
...
theorem denote_splitFunctionDomainValue_iff
    ...
    (BinarySchema.splitFunctionDomainValue 𝒞).denote
        env input output ↔
      ℳ.IsFunctionDomainSplit 𝕀 (env.bound 0) (env.bound 1) input output := by
...
namespace ZF
/--
非空定义域上的常值函数把目标集模型内部地单射到相应函数集。
-/
theorem exists_constantFunctionInjection
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {space source target : ℳ.Domain} (hSpace : ℳ.IsFunctionSpace 𝕀 space source target) (hSourceNonempty : ∃ argument, ℳ.mem argument source) :
    ∃ map,
      ℳ.IsSetInjectionFromTo 𝕀 map target space := by
  rcases hSourceNonempty with
    ⟨argument, hArgument⟩
  let env : Env ℳ 2 := {
  ...
  apply exists_setInjectionFromTo_of_denote
      hZF 𝕀 (Definitional.Project.BinarySchema.constantFunctionValue 𝒞)
      env
  · intro input hInput
    rcases exists_constantFunction hZF 𝕀 hInput with
      ⟨constant, hConstant, hPairs⟩
    exact ⟨constant, (Definitional.Project.Formula.denote_constantFunctionValue_iff
        𝕀 hZF.1 env input constant).mpr
          ⟨hConstant, hPairs⟩⟩
  · intro input _ first second hFirst hSecond
    rw [Definitional.Project.Formula.denote_constantFunctionValue_iff
      𝕀 hZF.1] at hFirst hSecond
    apply Structure.IsSetRelation.eq_of_pairMember_iff hZF.1
      hFirst.1.1.1 hSecond.1.1.1
    intro current value
    rw [hFirst.2 current value, hSecond.2 current value]
  · intro input output _ hOutput
    rw [Definitional.Project.Formula.denote_constantFunctionValue_iff
      𝕀 hZF.1] at hOutput
    exact (hSpace output).mpr hOutput.1
  · intro first second output _ _ hFirst hSecond
    rw [Definitional.Project.Formula.denote_constantFunctionValue_iff
      𝕀 hZF.1] at hFirst hSecond
    have hPair :
        ℳ.PairMember 𝕀 argument first output := (hFirst.2 argument first).mpr ⟨hArgument, rfl⟩
    exact ((hSecond.2 argument first).mp hPair).2
/--
对一个共同定义域的函数族，在固定坐标逐点求值得到模型内部函数。
-/
theorem exists_functionFamilyEvaluation
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {family familyDomain rows space functionDomain target input : ℳ.Domain} (hFamily :
      ℳ.IsSetFunctionFromTo 𝕀 family familyDomain space) (hRowsSubset :
      ℳ.MemberSubset rows familyDomain) (hSpace :
      ℳ.IsFunctionSpace 𝕀 space functionDomain target) (hInput : ℳ.mem input functionDomain) :
    ∃ evaluation,
      ℳ.IsSetFunctionFromTo 𝕀 evaluation rows target ∧
        ∀ row output,
          ℳ.PairMember 𝕀 row output evaluation ↔
            ℳ.mem row rows ∧
              ∃ function,
                ℳ.PairMember 𝕀 row function family ∧
                  ℳ.PairMember 𝕀 input output function := by
  let env : Env ℳ 2 := {
    bound := Fin.cases family <| Fin.cases input Fin.elim0
    free := fun _ => Classical.choice ℳ.nonempty
  }
  rcases exists_setFunctionFromTo_of_denote
      hZF 𝕀 (Definitional.Project.BinarySchema.familyEvaluationValue 𝒞)
      env (by
        intro row hRow
        rcases hFamily.2.2 row (hRowsSubset row hRow) with
          ⟨function, hFunctionSpace, hFamilyPair⟩
        have hFunction := (hSpace function).mp hFunctionSpace
        rcases hFunction.2.2 input hInput with
          ⟨output, _, hValuePair⟩
        exact ⟨output, (Definitional.Project.Formula.denote_familyEvaluationValue_iff
            𝕀 env row output).mpr
              ⟨function, hFamilyPair, hValuePair⟩⟩) (by
        intro row hRow first second hFirst hSecond
        rw [Definitional.Project.Formula.denote_familyEvaluationValue_iff
          𝕀] at hFirst hSecond
        rcases hFirst with
          ⟨firstFunction, hFirstFamily, hFirstValue⟩
        rcases hSecond with
          ⟨secondFunction, hSecondFamily, hSecondValue⟩
        have hFunctionEq :=
          hFamily.1.2 row firstFunction secondFunction
            hFirstFamily hSecondFamily
        subst secondFunction
        have hFunctionSpace :=
          hFamily.output_mem_of_pairMember hFirstFamily
        exact (hSpace firstFunction).mp hFunctionSpace
          |>.1.2 input first second hFirstValue hSecondValue) (by
        intro row output hRow hValue
        rw [Definitional.Project.Formula.denote_familyEvaluationValue_iff
          𝕀] at hValue
        rcases hValue with
          ⟨function, hFamilyPair, hValuePair⟩
        have hFunctionSpace :=
          hFamily.output_mem_of_pairMember hFamilyPair
        exact (hSpace function).mp hFunctionSpace
          |>.output_mem_of_pairMember hValuePair) with
    ⟨evaluation, hEvaluation, hPairs⟩
  refine ⟨evaluation, hEvaluation, fun row output => ?_⟩
  rw [hPairs row output,
    Definitional.Project.Formula.denote_familyEvaluationValue_iff 𝕀]
  rfl
/--
...
theorem equinumerous_nestedFunctionSpace
    ...
    {innerSpace sourceSpace targetSpace
      left right product base : ℳ.Domain} (hInnerSpace :
      ℳ.IsFunctionSpace 𝕀 innerSpace left base) (hSourceSpace :
      ℳ.IsFunctionSpace 𝕀 sourceSpace right innerSpace) (hProduct :
      ℳ.IsCartesianProduct 𝕀 product left right) (hTargetSpace :
  ...
  · intro input hInput
    ...
    rcases exists_setFunctionFromTo_of_denote
        ...
        inputEnv (source := product) (target := base) (by
          ...
          have hInnerFunction := (hInnerSpace innerFunction).mp hInnerFunctionMem
          rcases hInnerFunction.2.2 leftValue hLeftValue with
            ⟨output, _, hInnerPair⟩
          exact ⟨output, (Definitional.Project.Formula.denote_uncurriedFunctionValue_iff
              𝕀 inputEnv productValue output).mpr
                ⟨leftValue, rightValue, innerFunction,
                  hCode, hInputPair, hInnerPair⟩⟩) (by
          ...
          have hInnerFunction := (hInnerSpace firstInner).mp hInnerFunctionMem
          exact hInnerFunction.1.2 firstLeft first second
            hFirstInner hSecondInner) (by
    ...
    have hUncurrying :
      ...
      · rintro ⟨leftValue, rightValue, innerFunction,
        ...
        have hInnerFunctionMem :=
          hInputFunction.output_mem_of_pairMember hOuterPair
        have hLeftValue := (hInnerSpace innerFunction).mp hInnerFunctionMem
        ...
        exact ⟨(hProduct productValue).mpr
          ...
          leftValue, rightValue, innerFunction,
          hCode, hOuterPair, hInnerPair⟩
    exact ⟨output, (Definitional.Project.Formula.denote_uncurryFunctionValue_iff
    ...
    · intro hFirstPair
      ...
      have hInnerEq : innerFunction = secondInner := by
        ...
        · intro hFirstInnerPair
          ...
          have hOutputPair := (hFirst.2 productValue value).mpr
              ⟨leftValue, rightValue, innerFunction,
        ...
        · intro hSecondInnerPair
          rcases 𝕀.total leftValue rightValue with
            ⟨productValue, hProductCode⟩
          have hOutputPair := (hSecond.2 productValue value).mpr
  ...
  · intro output hOutput
    ...
    rcases exists_setFunctionFromTo_of_denote
        ...
        sectionEnv (source := right) (target := innerSpace) (by
          ...
          rcases exists_setFunctionFromTo_of_denote
              ...
              valueEnv (source := left) (target := base) (by
                ...
                rcases hOutputFunction.2.2 productValue hProductValue with
                  ⟨value, _, hOutputPair⟩
                exact ⟨value, (Definitional.Project.Formula.denote_functionSectionValue_iff
                    𝕀 valueEnv leftValue value).mpr
                      ⟨productValue, hCode, hOutputPair⟩⟩) (by
          ...
          exact ⟨sectionFunction, (Definitional.Project.Formula.denote_functionSection_iff
              𝕀 hZF.1 sectionEnv rightValue sectionFunction).mpr hSection⟩) (by
          ...
          apply Structure.IsSetRelation.eq_of_pairMember_iff hZF.1
            hFirst.1.1.1 hSecond.1.1.1
          intro leftValue value
          rw [hFirst.2 leftValue value, hSecond.2 leftValue value]) (by
    ...
    have hUncurrying :
      ...
      · intro hOutputPair
        ...
        have hSectionDefinition := (hInputPairs rightValue sectionFunction).mp hInputPair |>.2
        rw [Definitional.Project.Formula.denote_functionSection_iff 𝕀 hZF.1]
          at hSectionDefinition
        have hSectionPair := (hSectionDefinition.2 leftValue value).mpr
...
theorem equinumerous_functionSpaceIntoProduct
    ...
    {sourceSpace leftSpace rightSpace targetProduct
      source product left right : ℳ.Domain} (hSourceSpace :
      ℳ.IsFunctionSpace 𝕀 sourceSpace source product) (hLeftSpace :
      ℳ.IsFunctionSpace 𝕀 leftSpace source left) (hRightSpace :
      ℳ.IsFunctionSpace 𝕀 rightSpace source right) (hTargetProduct :
      ℳ.IsCartesianProduct 𝕀 targetProduct leftSpace rightSpace) (hProduct :
  ...
  · intro input hInput
    ...
    rcases exists_setFunctionFromTo_of_denote
        ...
        inputEnv (source := source) (target := left) (by
          intro argument hArgument
          rcases hInputFunction.2.2 argument hArgument with
            ⟨productValue, hProductValue, hInputPair⟩
          rcases (hProduct productValue).mp hProductValue with
            ⟨leftValue, _, rightValue, _, hCode⟩
          exact ⟨leftValue, (Definitional.Project.Formula.denote_leftFunctionProjectionValue_iff
              𝕀 inputEnv argument leftValue).mpr
                ⟨productValue, rightValue, hInputPair, hCode⟩⟩) (by
          ...
          subst secondProduct
          exact (𝕀.injective hFirstCode hSecondCode).1) (by
          intro _ output _ hValue
          rw [Definitional.Project.Formula.denote_leftFunctionProjectionValue_iff 𝕀]
            at hValue
    ...
    rcases exists_setFunctionFromTo_of_denote
        ...
        inputEnv (source := source) (target := right) (by
          intro argument hArgument
          rcases hInputFunction.2.2 argument hArgument with
            ⟨productValue, hProductValue, hInputPair⟩
          rcases (hProduct productValue).mp hProductValue with
            ⟨leftValue, _, rightValue, _, hCode⟩
          exact ⟨rightValue, (Definitional.Project.Formula.denote_rightFunctionProjectionValue_iff
              𝕀 inputEnv argument rightValue).mpr
                ⟨productValue, leftValue, hInputPair, hCode⟩⟩) (by
          intro argument _ first second hFirst hSecond
          ...
          have hProductEq :=
            hInputFunction.1.2 argument firstProduct secondProduct
              hFirstPair hSecondPair
          subst secondProduct
          exact (𝕀.injective hFirstCode hSecondCode).2) (by
          intro _ output _ hValue
          rw [Definitional.Project.Formula.denote_rightFunctionProjectionValue_iff 𝕀]
            at hValue
          rcases hValue with ⟨productValue, _, hPair, hCode⟩
    ...
    rcases 𝕀.total leftFunction rightFunction with
      ⟨output, hOutputCode⟩
    exact ⟨output, (Definitional.Project.Formula.denote_splitFunctionCodomainValue_iff
  ...
  · intro first second output hFirstMem hSecondMem hFirst hSecond
    ...
    · intro hFirstPair
      ...
      rcases hSecondFunction.2.2 argument (hFirstFunction.input_mem_of_pairMember hFirstPair) with
      ...
      have hFirstLeftPair := (hFirstLeft.2 argument leftValue).mpr
          ⟨productValue, rightValue, hFirstPair, hProductCode⟩
      have hSecondLeftPair := (hSecondLeft.2 argument secondLeftValue).mpr
      ...
      have hFirstRightPair := (hFirstRight.2 argument rightValue).mpr
          ⟨productValue, leftValue, hFirstPair, hProductCode⟩
      have hSecondRightPair := (hSecondRight.2 argument secondRightValue).mpr
    ...
    · intro hSecondPair
      ...
      rcases (hProduct productValue).mp hProductValue with
        ⟨leftValue, hLeftValue,
          rightValue, hRightValue, hProductCode⟩
      rcases hFirstFunction.2.2 argument (hSecondFunction.input_mem_of_pairMember hSecondPair) with
      ...
      have hSecondLeftPair := (hSecondLeft.2 argument leftValue).mpr
          ⟨productValue, rightValue, hSecondPair, hProductCode⟩
      have hFirstLeftPair := (hFirstLeft.2 argument firstLeftValue).mpr
          ⟨firstProduct, firstRightValue, hFirstPair, hFirstCode⟩
      have hLeftValueEq :=
        hFirstLeft.1.1.2 argument firstLeftValue leftValue
          hFirstLeftPair hSecondLeftPair
      have hSecondRightPair := (hSecondRight.2 argument rightValue).mpr
          ⟨productValue, leftValue, hSecondPair, hProductCode⟩
      have hFirstRightPair := (hFirstRight.2 argument firstRightValue).mpr
  ...
  · intro output hOutput
    ...
    rcases exists_setFunctionFromTo_of_denote
        ...
        inputEnv (source := source) (target := product) (by
          intro argument hArgument
          ...
          rcases 𝕀.total leftValue rightValue with
            ⟨productValue, hCode⟩
          exact ⟨productValue, (Definitional.Project.Formula.denote_combineFunctionCoordinatesValue_iff
              𝕀 inputEnv argument productValue).mpr
                ⟨leftValue, rightValue,
                  hLeftPair, hRightPair, hCode⟩⟩) (by
          ...
          subst secondLeft
          subst secondRight
          exact 𝕀.unique hFirstCode hSecondCode) (by
    ...
    have hLeftProjection :
      ...
      · intro hLeftPair
        ...
        have hInputPair := (hInputPairs argument productValue).mpr
          ⟨hArgument, (Definitional.Project.Formula.denote_combineFunctionCoordinatesValue_iff
              𝕀 inputEnv argument productValue).mpr
                ⟨leftValue, rightValue,
                  hLeftPair, hRightPair, hCode⟩⟩
...
theorem equinumerous_functionSpaceOverUnion
    ...
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {sourceSpace leftSpace rightSpace targetProduct
      source left right target : ℳ.Domain} (hSourceSpace :
      ℳ.IsFunctionSpace 𝕀 sourceSpace source target) (hLeftSpace :
      ℳ.IsFunctionSpace 𝕀 leftSpace left target) (hRightSpace :
      ℳ.IsFunctionSpace 𝕀 rightSpace right target) (hTargetProduct :
      ℳ.IsCartesianProduct 𝕀 targetProduct leftSpace rightSpace) (hSourceUnion :
      ℳ.IsUnionOfTwo source left right) (hDisjoint :
  ...
  · intro input hInput
    ...
    rcases 𝕀.total leftFunction rightFunction with
      ⟨output, hOutputCode⟩
    exact ⟨output, (Definitional.Project.Formula.denote_splitFunctionDomainValue_iff
  ...
  · intro first second output hFirstMem hSecondMem hFirst hSecond
    ...
    · intro hFirstPair
      ...
      · have hRestricted := (hFirstLeft.2 input value).mpr ⟨hInputLeft, hFirstPair⟩
        exact (hSecondLeft.2 input value).mp hRestricted |>.2
      · have hRestricted := (hFirstRight.2 input value).mpr ⟨hInputRight, hFirstPair⟩
        exact (hSecondRight.2 input value).mp hRestricted |>.2
    · intro hSecondPair
      have hInput := hSecondFunction.input_mem_of_pairMember hSecondPair
      rcases (hSourceUnion input).mp hInput with
        hInputLeft | hInputRight
      · have hRestricted := (hSecondLeft.2 input value).mpr ⟨hInputLeft, hSecondPair⟩
        exact (hFirstLeft.2 input value).mp hRestricted |>.2
      · have hRestricted := (hSecondRight.2 input value).mpr ⟨hInputRight, hSecondPair⟩
  ...
  · intro output hOutput
    ...
    have hUnionPairs (argument value : ℳ.Domain) :
      ...
      · intro hPair
        ...
        · rcases hPairLeft with ⟨pair, hCode, hPair⟩
          exact ⟨pair, hCode, (hInputUnion pair).mpr <| Or.inl hPair⟩
        · rcases hPairRight with ⟨pair, hCode, hPair⟩
          exact ⟨pair, hCode, (hInputUnion pair).mpr <| Or.inr hPair⟩
    have hLeftRestriction :
        ℳ.IsRestrictionOf 𝕀 leftFunction input left := by
      refine ⟨hLeftFunction.1.1, fun argument value => ?_⟩
      constructor
      · intro hPair
        exact ⟨hLeftFunction.input_mem_of_pairMember hPair, (hUnionPairs argument value).mpr <| Or.inl hPair⟩
    ...
    have hRightRestriction :
      ...
      constructor
      · intro hPair
        exact ⟨hRightFunction.input_mem_of_pairMember hPair, (hUnionPairs argument value).mpr <| Or.inr hPair⟩
      · rintro ⟨hArgument, hPair⟩
        rcases (hUnionPairs argument value).mp hPair with
          hPairLeft | hPairRight
        · exact False.elim <| hDisjoint argument
            ⟨hLeftFunction.input_mem_of_pairMember hPairLeft,
              hArgument⟩
        · exact hPairRight
    exact ⟨input, hInputMem, (Definitional.Project.Formula.denote_splitFunctionDomainValue_iff
        𝕀 env input output).mpr
          ⟨leftFunction, rightFunction,
            hLeftRestriction, hRightRestriction, hOutputCode⟩⟩
/-- 空定义域上的函数集与任意单元素集等势。 -/
theorem equinumerous_functionSpaceFromEmpty
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {space source target singleton value : ℳ.Domain} (hSpace : ℳ.IsFunctionSpace 𝕀 space source target) (hSourceEmpty : ∀ member, ¬ ℳ.mem member source)
...
theorem equinumerous_functionSpaceIntoSingleton
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {space source target value : ℳ.Domain} (hSpace : ℳ.IsFunctionSpace 𝕀 space source target) (hTarget : ℳ.IsSingletonOf target value) :
    ℳ.Equinumerous 𝕀 space target := by
  have hValue : ℳ.mem value target := (hTarget value).mpr rfl
    ...
    · intro hFunction
      ...
      · intro hPair
        exact (hConstantPairs input output).mpr
          ⟨hFunction.input_mem_of_pairMember hPair, (hTarget output).mp <|
...
theorem equinumerous_functionSpaceIntoEmpty_of_nonempty
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {space source target : ℳ.Domain} (hSpace : ℳ.IsFunctionSpace 𝕀 space source target) (hSourceNonempty : ∃ member, ℳ.mem member source)
