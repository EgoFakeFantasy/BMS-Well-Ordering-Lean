...
def IsSuccessorLengthSequenceWithLast {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (sequence last : ℳ.Domain) : Prop :=
  ∃ predecessor,
...
def IsLimitLengthSequenceWithUnion {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (sequence limit : ℳ.Domain) : Prop :=
  ∃ length,
...
def IsOrdinalOne (ℳ : Structure.{u}) (one : ℳ.Domain) : Prop :=
  ∃ zero, (∀ value, ¬ ℳ.mem value zero) ∧
      ℳ.SuccessorOf one zero
/-- 固定左参数的序数加法递归阶段。 -/
def IsOrdinalAdditionStep {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (left sequence output : ℳ.Domain) : Prop :=
  (ℳ.IsZeroLengthSequence 𝕀 sequence ∧ output = left) ∨ (∃ last,
...
def IsOrdinalAddition {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (sum left right : ℳ.Domain) : Prop :=
  ℳ.IsRecursionValue 𝕀 (ℳ.IsOrdinalAdditionStep 𝕀 left) right sum
/--
固定左参数的序数乘法递归阶段。
序数左参数使用文献递归；非序数左参数的空集分支只用于满足递归内核的全定义合同。
-/
def IsOrdinalMultiplicationStep {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (left sequence output : ℳ.Domain) : Prop := (¬ ℳ.IsOrdinal left ∧
      ∀ value, ¬ ℳ.mem value output) ∨ (ℳ.IsOrdinal left ∧ ((ℳ.IsZeroLengthSequence 𝕀 sequence ∧
          ∀ value, ¬ ℳ.mem value output) ∨ (∃ last,
...
def IsOrdinalMultiplication {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (product left right : ℳ.Domain) : Prop :=
  ℳ.IsRecursionValue 𝕀 (ℳ.IsOrdinalMultiplicationStep 𝕀 left) right product
/-- 固定底数的序数幂递归阶段。 -/
def IsOrdinalExponentiationStep {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (base sequence output : ℳ.Domain) : Prop :=
  (ℳ.IsZeroLengthSequence 𝕀 sequence ∧
      ℳ.IsOrdinalOne output) ∨ (∃ last,
      ℳ.IsSuccessorLengthSequenceWithLast 𝕀 sequence last ∧
        ℳ.IsOrdinalMultiplication 𝕀 output last base) ∨
    ℳ.IsLimitLengthSequenceWithUnion 𝕀 sequence output
/-- `power` 是 `base ^ exponent` 的超限递归值。 -/
def IsOrdinalExponentiation {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (power base exponent : ℳ.Domain) : Prop :=
  ℳ.IsRecursionValue 𝕀 (ℳ.IsOrdinalExponentiationStep 𝕀 base) exponent power
/-- `dividend` 关于 `divisor` 的序数商余分解。 -/
def IsOrdinalDivision {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (dividend divisor quotient remainder : ℳ.Domain) : Prop :=
...
def IsSetCodedLinearOrder {ℳ : Structure.{u}}
  ...
  ℳ.IsSetRelation 𝕀 relation ∧ ((∀ value, ℳ.mem value carrier →
        ¬ ℳ.PairMember 𝕀 value value relation) ∧ (∀ left, ℳ.mem left carrier →
...
def IsLinearOrderSumRelation {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (sumRelation leftCarrier leftRelation rightCarrier rightRelation :
      ℳ.Domain) : Prop :=
  ∀ left right,
    ℳ.PairMember 𝕀 left right sumRelation ↔ (ℳ.mem left leftCarrier ∧ ℳ.mem right leftCarrier ∧
        ℳ.PairMember 𝕀 left right leftRelation) ∨ (ℳ.mem left rightCarrier ∧ ℳ.mem right rightCarrier ∧
        ℳ.PairMember 𝕀 left right rightRelation) ∨ (ℳ.mem left leftCarrier ∧ ℳ.mem right rightCarrier)
/-- `sumCarrier, sumRelation` 是两个不相交线性序的序和。 -/
def IsLinearOrderSum {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (sumCarrier sumRelation leftCarrier leftRelation
...
def IsRightLexicographicProductRelation {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (productRelation leftCarrier leftRelation
      rightCarrier rightRelation : ℳ.Domain) : Prop :=
        ...
        ∃ firstRight, ℳ.mem firstRight rightCarrier ∧
          ∃ secondLeft, ℳ.mem secondLeft leftCarrier ∧
            ∃ secondRight, ℳ.mem secondRight rightCarrier ∧
              ...
              𝕀.Codes secondPair secondLeft secondRight ∧ (ℳ.PairMember 𝕀 firstRight secondRight
                  rightRelation ∨ (ℳ.SameMembers firstRight secondRight ∧
                  ℳ.PairMember 𝕀 firstLeft secondLeft
                    leftRelation))
/-- `productCarrier, productRelation` 是两个线性序的右字典序积。 -/
def IsLinearOrderProduct {ℳ : Structure.{u}}
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (productCarrier productRelation leftCarrier leftRelation
      rightCarrier rightRelation : ℳ.Domain) : Prop :=
  ℳ.IsSetCodedLinearOrder 𝕀 leftRelation leftCarrier ∧
    ℳ.IsSetCodedLinearOrder 𝕀 rightRelation rightCarrier ∧
...
theorem satisfies_isSuccessorLengthSequenceWithLast_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ)
    {depth : Nat} (env : Env ℳ depth) (sequence last : Term depth) :
    satisfies env (isSuccessorLengthSequenceWithLast 𝒞 sequence last) ↔
      ℳ.IsSuccessorLengthSequenceWithLast 𝕀 (sequence.eval env) (last.eval env) := by
...
theorem satisfies_isLimitLengthSequenceWithUnion_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ)
    {depth : Nat} (env : Env ℳ depth) (sequence limit : Term depth) :
    satisfies env (isLimitLengthSequenceWithUnion 𝒞 sequence limit) ↔
      ℳ.IsLimitLengthSequenceWithUnion 𝕀 (sequence.eval env) (limit.eval env) := by
...
theorem denote_ordinalAdditionOperator_iff
    ...
    (ordinalAdditionOperator 𝒞).denote
        env sequence output ↔
      ℳ.IsOrdinalAdditionStep 𝕀 (env.bound 0) sequence output := by
...
theorem denote_ordinalAddition_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ) (env : Env ℳ 1) (right sum : ℳ.Domain) :
    (ordinalAddition 𝒞).denote env right sum ↔
      ℳ.IsOrdinalAddition 𝕀 sum (env.bound 0) right := by
  have hOperator : (ordinalAdditionOperator 𝒞).denote env =
...
theorem denote_ordinalMultiplicationOperator_iff
    ...
    (ordinalMultiplicationOperator 𝒞).denote
        env sequence output ↔
      ℳ.IsOrdinalMultiplicationStep 𝕀 (env.bound 0) sequence output := by
...
theorem denote_ordinalMultiplication_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ) (env : Env ℳ 1) (right product : ℳ.Domain) :
    (ordinalMultiplication 𝒞).denote env right product ↔
      ℳ.IsOrdinalMultiplication 𝕀
        product (env.bound 0) right := by
  have hOperator : (ordinalMultiplicationOperator 𝒞).denote env =
  ...
  rw [Formula.denote_transfiniteRecursion_iff
    𝕀 hExt env (ordinalMultiplicationOperator 𝒞) right product]
  rw [hOperator]
  rfl
end BinarySchema
namespace Formula
...
theorem denote_ordinalExponentiationOperator_iff
    ...
    (ordinalExponentiationOperator 𝒞).denote
        env sequence output ↔
      ℳ.IsOrdinalExponentiationStep 𝕀 (env.bound 0) sequence output := by
...
theorem denote_ordinalExponentiation_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ) (env : Env ℳ 1) (exponent power : ℳ.Domain) :
    (ordinalExponentiation 𝒞).denote env exponent power ↔
      ℳ.IsOrdinalExponentiation 𝕀
        power (env.bound 0) exponent := by
  have hOperator : (ordinalExponentiationOperator 𝒞).denote env =
  ...
  rw [Formula.denote_transfiniteRecursion_iff
    𝕀 hExt env (ordinalExponentiationOperator 𝒞) exponent power]
  rw [hOperator]
  rfl
end BinarySchema
namespace Formula
...
theorem satisfies_isOrdinalDivision_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ) (hExt : Extensional ℳ)
    {depth : Nat} (env : Env ℳ depth) (dividend divisor quotient remainder : Term depth) :
    satisfies env (isOrdinalDivision 𝒞
          dividend divisor quotient remainder) ↔
      ℳ.IsOrdinalDivision 𝕀 (dividend.eval env) (divisor.eval env) (quotient.eval env) (remainder.eval env) := by
...
theorem denote_setCoded_iff
  ...
  change
    Formula.satisfies ((env.push left).push right) (Formula.orderedPairMem 𝒞 (.bound 1) (.bound 0) (.bound 2)) ↔
...
theorem satisfies_isSetCodedLinearOrder_iff
    ...
    satisfies env (isSetCodedLinearOrder 𝒞 relation carrier) ↔
...
theorem satisfies_isLinearOrderSumRelation_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {depth : Nat} (env : Env ℳ depth) (sumRelation leftCarrier leftRelation rightCarrier rightRelation :
      Term depth) :
    satisfies env (isLinearOrderSumRelation 𝒞 sumRelation
          leftCarrier leftRelation rightCarrier rightRelation) ↔
      ℳ.IsLinearOrderSumRelation 𝕀 (sumRelation.eval env) (leftCarrier.eval env) (leftRelation.eval env) (rightCarrier.eval env) (rightRelation.eval env) := by
...
theorem satisfies_isLinearOrderSum_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {depth : Nat} (env : Env ℳ depth) (sumCarrier sumRelation leftCarrier leftRelation
      rightCarrier rightRelation : Term depth) :
    satisfies env (isLinearOrderSum 𝒞 sumCarrier sumRelation
          leftCarrier leftRelation rightCarrier rightRelation) ↔
      ℳ.IsLinearOrderSum 𝕀 (sumCarrier.eval env) (sumRelation.eval env) (leftCarrier.eval env) (leftRelation.eval env)
...
theorem satisfies_isRightLexicographicProductRelation_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {depth : Nat} (env : Env ℳ depth) (productRelation leftCarrier leftRelation
      rightCarrier rightRelation : Term depth) :
    satisfies env (isRightLexicographicProductRelation 𝒞 productRelation
          leftCarrier leftRelation rightCarrier rightRelation) ↔
      ℳ.IsRightLexicographicProductRelation 𝕀 (productRelation.eval env) (leftCarrier.eval env) (leftRelation.eval env)
        (rightCarrier.eval env) (rightRelation.eval env) := by
...
theorem satisfies_isLinearOrderProduct_iff
    {ℳ : Structure.{u}} {𝒞 : OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {depth : Nat} (env : Env ℳ depth) (productCarrier productRelation leftCarrier leftRelation
      rightCarrier rightRelation : Term depth) :
    satisfies env (isLinearOrderProduct 𝒞 productCarrier productRelation
          leftCarrier leftRelation rightCarrier rightRelation) ↔
      ℳ.IsLinearOrderProduct 𝕀 (productCarrier.eval env) (productRelation.eval env) (leftCarrier.eval env) (leftRelation.eval env)
        (rightCarrier.eval env) (rightRelation.eval env) := by
