...
theorem ordinalAddition_isIncreasingOnOrdinals
    ...
    ℳ.IsIncreasingOnOrdinals (fun right sum =>
        ℳ.IsOrdinalAddition 𝕀 sum left right) := by
  let env : Env ℳ 1 := {
    bound := fun _ => left
    free := fun _ => Classical.choice ℳ.nonempty
  }
  have hRelation : (Definitional.Project.BinarySchema.ordinalAddition 𝒞).denote env =
        fun right sum =>
          ℳ.IsOrdinalAddition 𝕀 sum left right := by
    funext right sum
    apply propext
  ...
  have hIncreasing :
      ℳ.IsIncreasingOnOrdinals ((Definitional.Project.BinarySchema.ordinalAddition 𝒞).denote env) := by
    apply increasingOnOrdinals_of_progressive hZF env (Definitional.Project.BinarySchema.ordinalAddition 𝒞)
    ...
    · exact False.elim (hEmpty predecessor hPredecessorOrdinal)
    · rcases hSuccessor with
      ...
      have hImmediateMem : ℳ.mem immediate α := (hSuccessor immediate).mpr (Or.inr fun _ => Iff.rfl)
      have hImmediateValueMem : ℳ.mem immediateValue αValue := (hValueSuccessor immediateValue).mpr (Or.inr fun _ => Iff.rfl)
...
theorem ordinalAddition_isContinuousOnOrdinals
    ...
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {left : ℳ.Domain} :
    ℳ.IsContinuousOnOrdinals (fun right sum =>
        ℳ.IsOrdinalAddition 𝕀 sum left right) := by
  intro α value hData
  exact (ordinalAddition_limit_iff
...
theorem ordinalAddition_isNormalOrdinalFunction
    ...
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {left : ℳ.Domain} (hLeft : ℳ.IsOrdinal left) :
    ℳ.IsNormalOrdinalFunction (fun right sum =>
...
theorem ordinalMultiplication_isIncreasingOnOrdinals
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {left : ℳ.Domain} (hLeft : ℳ.IsOrdinal left) (hLeftNonempty : ∃ value, ℳ.mem value left) :
    ℳ.IsIncreasingOnOrdinals (fun right product =>
  ...
  have hIncreasing :
      ℳ.IsIncreasingOnOrdinals ((Definitional.Project.BinarySchema.ordinalMultiplication 𝒞).denote env) := by
    apply increasingOnOrdinals_of_progressive hZF env (Definitional.Project.BinarySchema.ordinalMultiplication 𝒞)
    intro α hα hPrevious predecessor
      hPredecessorOrdinal predecessorValue αValue
      hPredecessorValue hαValue
    rw [hRelation] at hPrevious hPredecessorValue hαValue
    ...
    · rcases hSuccessor with
      ...
      have hZeroLeft : ℳ.mem zero left :=
        hLeft.empty_mem_of_nonempty (ZF.modelsKP hZF) hLeftNonempty hZero
      have hImmediatePlusZero :
          ℳ.IsOrdinalAddition 𝕀
            immediateValue immediateValue zero := (ordinalAddition_zero_iff
          hZF 𝕀 hZero).mpr rfl
...
theorem ordinalMultiplication_isContinuousOnOrdinals
    ...
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {left : ℳ.Domain} (hLeft : ℳ.IsOrdinal left) :
    ℳ.IsContinuousOnOrdinals (fun right product =>
        ℳ.IsOrdinalMultiplication 𝕀 product left right) := by
  intro α value hData
  exact (ordinalMultiplication_limit_iff
...
theorem ordinalMultiplication_isNormalOrdinalFunction
    ...
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {left : ℳ.Domain} (hLeft : ℳ.IsOrdinal left) (hLeftNonempty : ∃ value, ℳ.mem value left) :
    ℳ.IsNormalOrdinalFunction (fun right product =>
...
theorem ordinalExponentiation_isNonemptyOnOrdinals
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {base : ℳ.Domain} (hBase : ℳ.IsOrdinal base) (hBaseNonempty : ∃ value, ℳ.mem value base) :
  ...
  have hRelation : (Definitional.Project.BinarySchema.ordinalExponentiation 𝒞).denote env =
        fun exponent power =>
  ...
  have hNonempty :=
    nonemptyValuesOnOrdinals_of_progressive hZF env (Definitional.Project.BinarySchema.ordinalExponentiation 𝒞)
      (fun exponent hExponent hPrevious power hPower => by
        ...
        · have hPowerOne := (ordinalExponentiation_zero_iff
              hZF 𝕀 hBase hZero).mp hPower
          rcases hPowerOne with
            ⟨zero, hEmpty, hPowerSuccessor⟩
          exact ⟨zero, (hPowerSuccessor zero).mpr (Or.inr fun _ => Iff.rfl)⟩
        · rcases hSuccessor with
          ...
          have hPredecessorMem : ℳ.mem predecessor exponent := (hSuccessor predecessor).mpr (Or.inr fun _ => Iff.rfl)
          ...
          have hZeroBase : ℳ.mem zero base :=
            hBase.empty_mem_of_nonempty (ZF.modelsKP hZF) hBaseNonempty hZero
          ...
          rcases ordinalMultiplication_existsUnique hZF
              𝕀 previous (Structure.IsOrdinal.of_no_members hZero) with
            ⟨previousTimesZero, hPreviousTimesZero, _⟩
          have hPreviousTimesZeroEmpty := (ordinalMultiplication_zero_iff
          ...
          have hPreviousTimesZeroMem :
            ...
            ordinalMultiplication_isIncreasingOnOrdinals
              ...
              hPreviousNonempty
              zero base (Structure.IsOrdinal.of_no_members hZero) hBase
...
theorem ordinalExponentiation_isIncreasingOnOrdinals
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {base one : ℳ.Domain} (hBase : ℳ.IsOrdinal base) (hOne : ℳ.IsOrdinalOne one) (hOneBase : ℳ.mem one base) :
    ℳ.IsIncreasingOnOrdinals (fun exponent power =>
        ℳ.IsOrdinalExponentiation 𝕀
          power base exponent) := by
  ...
  have hRelation : (Definitional.Project.BinarySchema.ordinalExponentiation 𝒞).denote env =
    ...
    simpa [env] using
      Definitional.Project.BinarySchema.denote_ordinalExponentiation_iff
        𝕀 hZF.1 env exponent power
  have hIncreasing :
      ℳ.IsIncreasingOnOrdinals ((Definitional.Project.BinarySchema.ordinalExponentiation 𝒞).denote env) := by
    apply increasingOnOrdinals_of_progressive hZF env (Definitional.Project.BinarySchema.ordinalExponentiation 𝒞)
    ...
    · rcases hSuccessor with
      ...
      have hImmediateMem : ℳ.mem immediate exponent := (hSuccessor immediate).mpr (Or.inr fun _ => Iff.rfl)
      ...
      rcases ordinalMultiplication_existsUnique hZF
          𝕀 immediateValue (KP.ordinalOne_isOrdinal (ZF.modelsKP hZF) hOne) with
      ...
      have hImmediateValueMem : ℳ.mem immediateValue exponentValue := by
        have hComparison :=
          ordinalMultiplication_isIncreasingOnOrdinals
            ...
            one base (KP.ordinalOne_isOrdinal (ZF.modelsKP hZF) hOne)
            hBase hOneBase
      ...
      · have hEarlierValue : ℳ.mem predecessorValue immediateValue :=
          hPrevious immediate hImmediateMem
            predecessor hEarlier predecessorValue immediateValue
            hPredecessorValue hImmediateValue
        exact (ordinalExponentiation_isOrdinal hZF
...
theorem ordinalExponentiation_isNormalOrdinalFunction
    ...
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {base one : ℳ.Domain} (hBase : ℳ.IsOrdinal base) (hOne : ℳ.IsOrdinalOne one) (hOneBase : ℳ.mem one base) :
    ℳ.IsNormalOrdinalFunction (fun exponent power =>
        ℳ.IsOrdinalExponentiation 𝕀
          power base exponent) :=
...
theorem ordinalAddition_right_eq_or_mem
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {sum left right : ℳ.Domain} (hLeft : ℳ.IsOrdinal left) (hRight : ℳ.IsOrdinal right) (hSum : ℳ.IsOrdinalAddition 𝕀 sum left right) :
  ...
  have hNormal :
      ℳ.IsNormalOrdinalFunction ((Definitional.Project.BinarySchema.ordinalAddition 𝒞).denote env) := by
    rw [hRelation]
    exact ordinalAddition_isNormalOrdinalFunction
      hZF 𝕀 hLeft
  have hDominates :=
    normalValuesDominateInputs hZF env (Definitional.Project.BinarySchema.ordinalAddition 𝒞) hNormal
      right hRight sum
...
theorem ordinalMultiplication_right_eq_or_mem
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {product left right : ℳ.Domain} (hLeft : ℳ.IsOrdinal left) (hLeftNonempty : ∃ value, ℳ.mem value left) (hRight : ℳ.IsOrdinal right) (hProduct :
      ℳ.IsOrdinalMultiplication 𝕀 product left right) :
  ...
  have hRelation : (Definitional.Project.BinarySchema.ordinalMultiplication 𝒞).denote env =
    ...
    simpa [env] using
      Definitional.Project.BinarySchema.denote_ordinalMultiplication_iff
        𝕀 hZF.1 env input output
  have hNormal :
      ℳ.IsNormalOrdinalFunction ((Definitional.Project.BinarySchema.ordinalMultiplication 𝒞).denote env) := by
    rw [hRelation]
    exact ordinalMultiplication_isNormalOrdinalFunction
      hZF 𝕀 hLeft hLeftNonempty
  have hDominates :=
    normalValuesDominateInputs hZF env (Definitional.Project.BinarySchema.ordinalMultiplication 𝒞) hNormal
...
theorem ordinalExponentiation_exponent_eq_or_mem
    {ℳ : Structure.{u}} (hZF : ℳ.Models SetTheory.ZF)
    {𝒞 : Definitional.Project.OrderedPairConvention} (𝕀 : 𝒞.Interpretation ℳ)
    {power base exponent one : ℳ.Domain} (hBase : ℳ.IsOrdinal base) (hOne : ℳ.IsOrdinalOne one) (hOneBase : ℳ.mem one base) (hExponent : ℳ.IsOrdinal exponent)
    (hPower :
      ℳ.IsOrdinalExponentiation 𝕀 power base exponent) :
  ...
  have hRelation : (Definitional.Project.BinarySchema.ordinalExponentiation 𝒞).denote env =
    ...
    simpa [env] using
      Definitional.Project.BinarySchema.denote_ordinalExponentiation_iff
        𝕀 hZF.1 env input output
  have hNormal :
      ℳ.IsNormalOrdinalFunction ((Definitional.Project.BinarySchema.ordinalExponentiation 𝒞).denote env) := by
    rw [hRelation]
    exact ordinalExponentiation_isNormalOrdinalFunction
      hZF 𝕀 hBase hOne hOneBase
  have hDominates :=
    normalValuesDominateInputs hZF env (Definitional.Project.BinarySchema.ordinalExponentiation 𝒞) hNormal
