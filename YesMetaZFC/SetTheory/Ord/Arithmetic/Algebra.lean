...
theorem ordinalMultiplication_empty_left
  ...
  have hRelation : (Definitional.Project.BinarySchema.ordinalMultiplication 𝒞).denote env =
        fun right product =>
  ...
  have hEmptyValues :=
    emptyValuesOnOrdinals_of_progressive hZF env (Definitional.Project.BinarySchema.ordinalMultiplication 𝒞) (fun α hα hPrevious product hProduct => by
        rw [hRelation] at hPrevious hProduct
        rcases hα.classify hZF.1 with
          hEmpty | hSuccessor | hLimit
        · exact (ordinalMultiplication_zero_iff
              hZF 𝕀
              hLeftOrdinal
              hEmpty).mp hProduct
        · rcases hSuccessor with
          ...
          have hProductEq : product = previous := (ordinalAddition_zero_iff
              hZF 𝕀 hLeftEmpty).mp
              hProductAddition
...
theorem ordinalAddition_assoc
    ...
    {left middle right leftMiddle middleRight
      leftAssociated rightAssociated : ℳ.Domain} (hLeft : ℳ.IsOrdinal left) (hMiddle : ℳ.IsOrdinal middle) (hRight : ℳ.IsOrdinal right) (hLeftMiddle :
      ℳ.IsOrdinalAddition 𝕀 leftMiddle left middle) (hMiddleRight :
      ℳ.IsOrdinalAddition 𝕀 middleRight middle right) (hLeftAssociated :
      ℳ.IsOrdinalAddition 𝕀
        leftAssociated left middleRight) (hRightAssociated :
      ℳ.IsOrdinalAddition 𝕀
  ...
  have hAgreement :=
    agreeOnOrdinals_of_progressive hZF env (Definitional.Project.BinarySchema.ordinalAdditionLeftAssociated 𝒞)
      (Definitional.Project.BinarySchema.ordinalAdditionRightAssociated 𝒞) (fun α hα hPrevious firstValue secondValue
        ...
        rcases hα.classify hZF.1 with
          hEmpty | hSuccessor | hLimit
        · have hMiddleValueEq := (ordinalAddition_zero_iff
              hZF 𝕀 hEmpty).mp hMiddleValue
          have hSecondValueEq := (ordinalAddition_zero_iff
              hZF 𝕀 hEmpty).mp hSecondValue
          subst middleValue
          subst secondValue
          rcases ordinalAddition_existsUnique hZF 𝕀 (env.bound 0) hMiddle with
            ⟨_, _, hUnique⟩
          exact (hUnique firstValue hFirstValue).trans (hUnique leftMiddleValue hLeftMiddleValue).symm
        · rcases hSuccessor with
            ⟨predecessor, hPredecessorOrdinal, hSuccessor⟩
          ...
          have hPredecessorEq :=
            hPrevious predecessor hPredecessorMem
              firstPredecessor secondPredecessor ((Definitional.Project.BinarySchema.denote_ordinalAdditionLeftAssociated_iff
                𝕀 hZF.1 env predecessor
                firstPredecessor).mpr
                ⟨middlePredecessor, hMiddlePredecessor,
                  hFirstPredecessor⟩) ((Definitional.Project.BinarySchema.denote_ordinalAdditionRightAssociated_iff
                𝕀 hZF.1 env predecessor
        ...
        · rcases (ordinalAddition_limit_iff
          ...
          · intro member
            ...
            · intro hMember
              ...
              rcases ordinalAddition_existsUnique hZF
                  𝕀 left (ordinalAddition_isOrdinal hZF 𝕀
                    hMiddle (hLimit.1.mem hIndex) hInnerValue) with
                ⟨outerValue, hOuterValue, _⟩
              have hValueEq :=
                hPrevious index hIndex outerValue member ((Definitional.Project.BinarySchema.denote_ordinalAdditionLeftAssociated_iff
                    𝕀 hZF.1 env index outerValue).mpr
                    ⟨innerValue, hInnerValue, hOuterValue⟩) ((Definitional.Project.BinarySchema.denote_ordinalAdditionRightAssociated_iff
            ...
            · rintro ⟨index, hIndex, innerValue,
                hInnerValue, hOuterValue⟩
              rcases ordinalAddition_existsUnique hZF
                  𝕀 leftMiddleValue (hLimit.1.mem hIndex) with
                ⟨rightValue, hRightValue, _⟩
              have hValueEq :=
                hPrevious index hIndex member rightValue ((Definitional.Project.BinarySchema.denote_ordinalAdditionLeftAssociated_iff
                    𝕀 hZF.1 env index member).mpr
                    ⟨innerValue, hInnerValue, hOuterValue⟩) ((Definitional.Project.BinarySchema.denote_ordinalAdditionRightAssociated_iff
              ...
              exact (hRange member).mpr
                ⟨index, hIndex, hRightValue⟩
          · exact hUnion)
  exact hAgreement right hRight leftAssociated rightAssociated ((Definitional.Project.BinarySchema.denote_ordinalAdditionLeftAssociated_iff
      𝕀 hZF.1 env right leftAssociated).mpr
      ⟨middleRight, hMiddleRight, hLeftAssociated⟩) ((Definitional.Project.BinarySchema.denote_ordinalAdditionRightAssociated_iff
...
theorem ordinalMultiplication_add
    ...
    {left middle right middleRight
      leftMiddle leftRight leftResult rightResult : ℳ.Domain} (hLeft : ℳ.IsOrdinal left) (hMiddle : ℳ.IsOrdinal middle) (hRight : ℳ.IsOrdinal right)
    (hMiddleRight :
      ℳ.IsOrdinalAddition 𝕀 middleRight middle right) (hLeftResult :
      ℳ.IsOrdinalMultiplication 𝕀
        leftResult left middleRight) (hLeftMiddle :
      ℳ.IsOrdinalMultiplication 𝕀
        leftMiddle left middle) (hLeftRight :
      ℳ.IsOrdinalMultiplication 𝕀
        leftRight left right) (hRightResult :
      ℳ.IsOrdinalAddition 𝕀
  ...
  · let env : Env ℳ 2 := {
    ...
    have hAgreement :=
      agreeOnOrdinals_of_progressive hZF env (Definitional.Project.BinarySchema.ordinalMultiplicationAdditionLeft 𝒞)
        (Definitional.Project.BinarySchema.ordinalMultiplicationAdditionRight 𝒞) (fun α hα hPrevious firstValue secondValue
            hFirstValue hSecondValue => by
          ...
          · have hMiddleValueEq := (ordinalAddition_zero_iff
                hZF 𝕀 hEmpty).mp hMiddleValue
            have hLeftRightEmpty := (ordinalMultiplication_zero_iff
          ...
          · rcases hSuccessor with
            ...
            have hPredecessorEq :=
              hPrevious predecessor hPredecessorMem
                firstPredecessor secondPredecessor ((Definitional.Project.BinarySchema.denote_ordinalMultiplicationAdditionLeft_iff
                  𝕀 hZF.1 env predecessor
                  firstPredecessor).mpr
                  ⟨middlePredecessor, hMiddlePredecessor,
                    hFirstPredecessor⟩) ((Definitional.Project.BinarySchema.denote_ordinalMultiplicationAdditionRight_iff
                  𝕀 hZF.1 env predecessor
                  secondPredecessor).mpr
                  ⟨leftMiddleValue, hLeftMiddleValue,
                    rightPredecessor, hRightPredecessor,
          ...
          · have hFirstOuter :=
            ...
            exact hPrevious index hIndex
              firstComposedValue secondComposedValue ((Definitional.Project.BinarySchema.denote_ordinalMultiplicationAdditionLeft_iff
                𝕀 hZF.1 env index
                firstComposedValue).mpr
                ⟨firstInnerValue, hFirstInnerValue,
                  hFirstComposedValue⟩) ((Definitional.Project.BinarySchema.denote_ordinalMultiplicationAdditionRight_iff
                𝕀 hZF.1 env index
                secondComposedValue).mpr
                ⟨leftMiddleValue, hLeftMiddleValue,
                  secondInnerValue, hSecondInnerValue,
                  hSecondComposedValue⟩))
    exact hAgreement right hRight leftResult rightResult ((Definitional.Project.BinarySchema.denote_ordinalMultiplicationAdditionLeft_iff
        𝕀 hZF.1 env right leftResult).mpr
        ⟨middleRight, hMiddleRight, hLeftResult⟩) ((Definitional.Project.BinarySchema.denote_ordinalMultiplicationAdditionRight_iff
  ...
  · have hLeftEmpty : ∀ value, ¬ ℳ.mem value left := by
    ...
    have hLeftResultEmpty :=
      ordinalMultiplication_empty_left hZF 𝕀
        hLeftEmpty middleRight (ordinalAddition_isOrdinal hZF 𝕀
    ...
    have hRightResultEq := (ordinalAddition_zero_iff
        hZF 𝕀 hLeftRightEmpty).mp hRightResult
    subst rightResult
    apply hZF.1.eq_of_same_members
    intro value
    exact iff_of_false (hLeftResultEmpty value) (hLeftMiddleEmpty value)
/-- 序数乘法满足结合律。 -/
theorem ordinalMultiplication_assoc
    ...
    {left middle right leftMiddle middleRight
      leftAssociated rightAssociated : ℳ.Domain} (hLeft : ℳ.IsOrdinal left) (hMiddle : ℳ.IsOrdinal middle) (hRight : ℳ.IsOrdinal right) (hLeftMiddle :
      ℳ.IsOrdinalMultiplication 𝕀
        leftMiddle left middle) (hMiddleRight :
      ℳ.IsOrdinalMultiplication 𝕀
        middleRight middle right) (hLeftAssociated :
      ℳ.IsOrdinalMultiplication 𝕀
        leftAssociated left middleRight) (hRightAssociated :
      ℳ.IsOrdinalMultiplication 𝕀
        rightAssociated leftMiddle right) :
  ...
  · by_cases hMiddleNonempty : ∃ value, ℳ.mem value middle
    · let env : Env ℳ 2 := {
      ...
      have hAgreement :=
        agreeOnOrdinals_of_progressive hZF env (Definitional.Project.BinarySchema.ordinalMultiplicationLeftAssociated 𝒞)
          (Definitional.Project.BinarySchema.ordinalMultiplicationRightAssociated 𝒞) (fun α hα hPrevious firstValue secondValue
              hFirstValue hSecondValue => by
            ...
            rcases hα.classify hZF.1 with
              hEmpty | hSuccessor | hLimit
            · have hMiddleValueEmpty := (ordinalMultiplication_zero_iff
                  hZF 𝕀 hMiddle hEmpty).mp
                  hMiddleValue
              have hFirstValueEmpty := (ordinalMultiplication_zero_iff
                  hZF 𝕀 hLeft hMiddleValueEmpty).mp
                  hFirstValue
              have hSecondValueEmpty := (ordinalMultiplication_zero_iff
                  hZF 𝕀 (ordinalMultiplication_isOrdinal hZF
                    𝕀 hLeft hMiddle hLeftMiddleValue)
                  hEmpty).mp hSecondValue
              apply hZF.1.eq_of_same_members
              intro value
              exact iff_of_false (hFirstValueEmpty value) (hSecondValueEmpty value)
            · rcases hSuccessor with
                ⟨predecessor, hPredecessorOrdinal, hSuccessor⟩
              rcases (ordinalMultiplication_successor_iff
                  hZF 𝕀 hMiddle
              ...
              have hPredecessorEq :=
                hPrevious predecessor hPredecessorMem
                  firstPredecessor secondPredecessor ((Definitional.Project.BinarySchema.denote_ordinalMultiplicationLeftAssociated_iff
                    𝕀 hZF.1 env predecessor
                    firstPredecessor).mpr
                    ⟨middlePredecessor, hMiddlePredecessor,
                      hFirstPredecessor⟩) ((
              ...
              rcases ordinalAddition_existsUnique hZF 𝕀
                  firstPredecessor hLeftMiddleValueOrdinal with
                ⟨_, _, hUnique⟩
              have hAdditionEq : firstAddition = secondValue := (hUnique firstAddition hFirstAddition).trans (hUnique secondValue hSecondAddition).symm
              ...
              · intro member
                ...
                · intro hMember
                  ...
                  rcases ordinalMultiplication_existsUnique hZF
                    ...
                    ⟨innerValue, hInnerValue, _⟩
                  rcases ordinalMultiplication_existsUnique hZF
                      𝕀 left (ordinalMultiplication_isOrdinal hZF
                        𝕀 hMiddle (hLimit.1.mem hIndex) hInnerValue) with
                    ⟨outerValue, hOuterValue, _⟩
                  have hValueEq :=
                ...
                · rintro ⟨index, hIndex, innerValue,
                  ...
                  exact (hRange member).mpr
                    ⟨index, hIndex, hRightValue⟩
              · exact hUnion)
      exact hAgreement right hRight leftAssociated rightAssociated ((Definitional.Project.BinarySchema.denote_ordinalMultiplicationLeftAssociated_iff
          𝕀 hZF.1 env right leftAssociated).mpr
          ⟨middleRight, hMiddleRight, hLeftAssociated⟩) ((Definitional.Project.BinarySchema.denote_ordinalMultiplicationRightAssociated_iff
          𝕀 hZF.1 env right rightAssociated).mpr
          ⟨leftMiddle, hLeftMiddle, hRightAssociated⟩)
    · have hMiddleEmpty : ∀ value, ¬ ℳ.mem value middle := by
      ...
      have hLeftAssociatedEmpty := (ordinalMultiplication_zero_iff
          hZF 𝕀 hLeft hMiddleRightEmpty).mp
          hLeftAssociated
      have hLeftMiddleEmpty := (ordinalMultiplication_zero_iff
      ...
      apply hZF.1.eq_of_same_members
      intro value
      exact iff_of_false (hLeftAssociatedEmpty value) (hRightAssociatedEmpty value)
  · have hLeftEmpty : ∀ value, ¬ ℳ.mem value left := by
      simpa only [not_exists] using hLeftNonempty
    have hLeftAssociatedEmpty :=
      ordinalMultiplication_empty_left hZF 𝕀
        hLeftEmpty middleRight (ordinalMultiplication_isOrdinal hZF 𝕀
          hMiddle hRight hMiddleRight)
