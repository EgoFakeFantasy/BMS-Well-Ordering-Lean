...
inductive Axiom : Definitional.Project.Theory where
  ...
  | separation {parameterCount : Nat} (schema : Definitional.Project.UnarySchema parameterCount) :
      Axiom (Axioms.Schema.separation schema)
  | collection {parameterCount : Nat} (schema : Definitional.Project.BinarySchema parameterCount) :
