...
import YesMetaZFC.SetTheory.Theory.Basic
/-!
...
inductive Axiom : Definitional.Project.Theory where
  ...
  | separation {parameterCount : Nat} (schema : Definitional.Project.Delta0UnarySchema parameterCount) :
      Axiom (Axioms.Schema.separation schema.toUnarySchema)
  | collection {parameterCount : Nat} (schema : Definitional.Project.Delta0BinarySchema parameterCount) :
