...
theorem intrinsic_arithmetic_evaluation_theory_subset_intrinsic_proof_theory
    {sentence : SetSentence}
    (hSentence : intrinsic_arithmetic_evaluation_theory sentence) :
    intrinsic_proof_theory sentence :=
  Or.inl hSentence

theorem intrinsic_proof_row_theory_subset_intrinsic_proof_theory
    {sentence : SetSentence}
    (hSentence : intrinsic_proof_row_theory sentence) :
    intrinsic_proof_theory sentence :=
  Or.inr hSentence
...
theorem intrinsic_syntax_carrier_theory_subset_intrinsic_proof_theory
    {sentence : SetSentence}
    (hSentence : intrinsic_syntax_carrier_theory sentence) :
    intrinsic_proof_theory sentence :=
  intrinsic_proof_row_theory_subset_intrinsic_proof_theory
    (intrinsic_syntax_carrier_theory_subset_intrinsic_proof_row_theory hSentence)

theorem expression_encoding_theory_subset_intrinsic_proof_theory
    {sentence : SetSentence}
    (hSentence : expression_encoding_theory sentence) :
    intrinsic_proof_theory sentence :=
  intrinsic_syntax_carrier_theory_subset_intrinsic_proof_theory
    (expression_encoding_theory_subset_intrinsic_syntax_carrier_theory hSentence)

theorem formal_language_encoding_theory_subset_intrinsic_proof_theory
    {sentence : SetSentence}
    (hSentence : formal_language_encoding_theory sentence) :
    intrinsic_proof_theory sentence :=
  intrinsic_syntax_carrier_theory_subset_intrinsic_proof_theory
    (formal_language_encoding_theory_subset_intrinsic_syntax_carrier_theory hSentence)

theorem natural_addition_bound_theory_subset_intrinsic_proof_theory
    {sentence : SetSentence}
    (hSentence : natural_addition_bound_theory sentence) :
    intrinsic_proof_theory sentence :=
  formal_language_encoding_theory_subset_intrinsic_proof_theory
    (natural_addition_bound_theory_subset_formal_language_encoding_theory hSentence)
...
theorem godel_pairing_core_theory_subset_intrinsic_proof_theory
    {sentence : SetSentence}
