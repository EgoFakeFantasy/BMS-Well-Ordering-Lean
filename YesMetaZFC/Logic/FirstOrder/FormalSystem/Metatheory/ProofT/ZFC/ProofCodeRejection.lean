...
def ProofT.ZFC.certificate_sequence
    (number : Nat) : SetTerm :=
  standard_token_sequence
    (nat_sequence_decode
      (godel_unpair_value number).2)

def ProofT.ZFC.witness
    (number : Nat)
...
theorem ProofT.ZFC.proof_sequence_boundary
    (number : Nat) :
    GodelQuotation.Numbered.CodeBoundary
      (ProofT.ZFC.proof_sequence number) := by
  ...
  constructor
  · simpa [ProofT.ZFC.proof_sequence, rows] using
      seq_admissible_m 0 hElements
  · simpa [ProofT.ZFC.proof_sequence, rows] using
      seq_support_nil_m 0 hElementsClosed

theorem ProofT.ZFC.certificate_sequence_boundary
    (number : Nat) :
    GodelQuotation.Numbered.CodeBoundary
      (ProofT.ZFC.certificate_sequence number) :=
...
theorem ProofT.ZFC.witness_admissible
    (number : Nat)
    (conclusion : SetTerm)
    (hConclusion :
  ...
  simpa [ProofT.ZFC.witness] using
...
theorem ProofT.ZFC.content_of_witness
    {Γ : Context signature}
    (number : Nat)
    (conclusion : SetTerm)
    (hConclusion :
    ...
    Γ ⊢ₘ[fs_zfc_support_raw_theory]
      (ProofT.ZFC.sequence_condition
          ...
          (ProofT.ZFC.certificate_sequence number)) ∧ₘ
        proof_sequence_terminal_condition
          (ProofT.ZFC.proof_sequence number)
          conclusion := by
  simpa [ProofT.ZFC.witness,
    ProofT.ZFC.proof_sequence,
    ProofT.ZFC.certificate_sequence] using
...
-/
theorem ProofT.ZFC.code_neg_of_length
    (number : Nat)
    (conclusion : SetTerm)
    (hConclusion :
      GodelQuotation.Numbered.CodeBoundary conclusion)
...
-/
theorem ProofT.ZFC.code_neg_of_formula_condition
    (number : Nat)
    (conclusion : SetTerm)
    (hConclusion :
      GodelQuotation.Numbered.CodeBoundary conclusion)
  ...
  let witnessBody : SetFormula :=
    ProofT.ZFC.witness number conclusion
  ...
  have hFormulaSpace :
    ...
    simpa [ProofT.ZFC.sequence_condition,
      ...
      ProofT.ZFC.proof_sequence, rows] using
      hSpaces
  have hRowIndex :
...
-/
theorem
    ProofT.ZFC.code_neg_of_formula_replay
    (number : Nat)
    (conclusion : SetTerm)
    (hConclusion :
      GodelQuotation.Numbered.CodeBoundary conclusion)
  ...
  have hRowReplay :
    ...
    ProofT.row_replay
      ...
      (by
        simpa [ProofT.ZFC.sequence_condition,
          ProofT.ZFC.proof_sequence] using
          hSequenceCondition)
  exact FirstOrder.Derives.negElim
    hRowReplay
    (FirstOrder.Derives.context_weaken
...
证明码条件被对象层拒绝。
-/
theorem ProofT.ZFC.code_neg_of_bad_token
    (number : Nat)
    (conclusion : SetTerm)
    (hConclusion :
      GodelQuotation.Numbered.CodeBoundary conclusion)
    ...
    Derives fs_zfc_support_raw_theory [] (
      ¬ₘ proof_condition
        ...
        ProofT.condition_base) := by
  apply
    ProofT.ZFC.code_neg_of_formula_condition
...
-/
theorem
    ProofT.ZFC.code_neg_of_no_left_opening
    (number : Nat)
    (conclusion : SetTerm)
    (hConclusion :
      GodelQuotation.Numbered.CodeBoundary conclusion)
...
-/
theorem
    ProofT.ZFC.code_neg_of_one_absent
    (number : Nat)
    (conclusion : SetTerm)
    (hConclusion :
      GodelQuotation.Numbered.CodeBoundary conclusion)
...
-/
theorem
    ProofT.ZFC.code_neg_or_decode_residual
    (number : Nat)
    (conclusion : SetTerm)
    (hConclusion :
      GodelQuotation.Numbered.CodeBoundary conclusion)
  ...
  | opening_present hRowDecode hOnePresent hOpening =>
      ...
      · rcases hBad with
        ...
        left
        exact
          ProofT.ZFC.code_neg_of_bad_token
...
-/
theorem
    ProofT.ZFC.code_neg_of_decode_residual
    (number : Nat)
    (conclusion : SetTerm)
    (hConclusion :
      GodelQuotation.Numbered.CodeBoundary conclusion)
...
被对象层拒绝。
-/
theorem ProofT.ZFC.code_neg_of_line
    (number : Nat)
    (conclusion : SetTerm)
    (hConclusion :
      GodelQuotation.Numbered.CodeBoundary conclusion)
  ...
  · intro Γ hWitness
    have hCanonical :=
      ProofT.ZFC.content_of_witness
        number conclusion hConclusion
        (by simpa [ProofT.ZFC.witness] using hWitness)
  ...
  · simpa [ProofT.ZFC.line_instance,
      ProofT.ZFC.line_condition] using hLineNeg
...
-/
theorem ProofT.ZFC.code_neg_of_bad_certificate
    (number : Nat)
    (conclusion : SetTerm)
    (hConclusion :
      GodelQuotation.Numbered.CodeBoundary conclusion)
  ...
  · rcases
    ...
    have hCertificateAt :
      ...
      simpa [ProofT.ZFC.certificate_sequence,
    ...
    have hLineNeg :
        Derives fs_zfc_support_raw_theory [] (
          ¬ₘ ProofT.ZFC.line_instance
            ...
            (ProofT.ZFC.certificate_sequence number)
            index) :=
      ProofT.ZFC.line_instance_neg_of_certificate_decode_none
        ProofT.ZFC.certificate_core
        (ProofT.ZFC.proof_sequence number)
        (ProofT.ZFC.certificate_sequence number)
        index rawCertificates[index]
        (ProofT.ZFC.proof_sequence_boundary number).1
        (ProofT.ZFC.certificate_sequence_boundary number).1
        (ProofT.ZFC.proof_sequence_boundary number).2
        (ProofT.ZFC.certificate_sequence_boundary number).2
        hCertificateAt
        (by simpa [rawCertificates] using hBadDecode)
    exact
      ProofT.ZFC.code_neg_of_line
        number conclusion hConclusion index
        (by simpa [rows] using hRowIndex)
        hLineNeg
  · exact
      ProofT.ZFC.code_neg_of_length
        number conclusion hConclusion
...
theorem
  ...
  | certificate_decode hDecode =>
      exact
        ProofT.ZFC.code_neg_of_bad_certificate
      ...
      have consume :
          ∀ (P : Prop) {state rows certificates},
            ...
            (∀ index row decoded certificate prefixState,
              ...
              FSReplayRowFailure
                ProofCode.fs_zfc_support_enumeration number prefixState
      ...
      · exact fun index row decoded certificate prefixState
          ...
          | @logical certificateCode hFailure =>
              ...
              have hCertificateAt :
                ...
                simpa [ProofT.ZFC.certificate_sequence] using
                  fs_zfc_support_raw_derives_of_standard_sequence
                    (standard_token_sequence_apply_getElem?
                      (nat_sequence_decode
                        (godel_unpair_value number).2)
              ...
              have hFormulaBoundary :
                  GodelQuotation.Numbered.CodeBoundary
                    (ProofT.ZFC.proof_sequence number ·ₘ
                      numₘ(index)) := by
                constructor
              ...
              have hFormulaToRow :
                ...
                simpa [ProofT.ZFC.proof_sequence,
              ...
              have hLineNeg :
                  Derives fs_zfc_support_raw_theory [] (
                    ¬ₘ ProofT.ZFC.line_instance
                      ...
                      (ProofT.ZFC.certificate_sequence number)
                      index) :=
                ProofT.ZFC.line_instance_neg_of_logical_ground
                  ProofT.ZFC.certificate_core
                  (ProofT.ZFC.proof_sequence number)
                  (ProofT.ZFC.certificate_sequence number)
          ...
          | @theory certificateCode hCheck =>
              ...
              have hFormulaToRow :
                  Derives fs_zfc_support_raw_theory [] (
                    (ProofT.ZFC.proof_sequence number ·ₘ
                        numₘ(index)) ≐ₘ
                      standard_token_sequence row) := by
                simpa [ProofT.ZFC.proof_sequence, rawRows,
                  hRowValue] using
                  ProofT.row_apply
                    ProofT.ZFC.object_replay
                    rawRows index hRowIndex
                ...
                have hLineNeg :
                    Derives fs_zfc_support_raw_theory [] (
                      ¬ₘ ProofT.ZFC.line_instance
                        ...
                        (ProofT.ZFC.certificate_sequence number)
                        index) :=
                  ProofT.ZFC.line_instance_neg_of_theory_ground
                    (ProofT.ZFC.proof_sequence number)
                    (ProofT.ZFC.certificate_sequence number)
                    index certificateCode
                    (ProofT.ZFC.proof_sequence_boundary number).1
              ...
              have hRejectFixed
                  ...
                  Derives fs_zfc_support_raw_theory [] (
                    ¬ₘ proof_condition
                      ...
                      ProofT.condition_base) := by
                rcases
                    fs_zfc_support_generate_none_or_formula_ne_of_verifier_false
                      hCheck with
                ...
                · have hRowNe :
                    ...
                    fs_zfc_support_raw_standard_row_ne_formula_code
                      hDecode
                      (fs_zfc_support_generate_admissible hGenerate)
                      (fs_zfc_support_generate_hilbertize_eq_self
                        hGenerate)
                      hDifferent
                  have hFormulaNe :
                      Derives fs_zfc_support_raw_theory [] (
              ...
              · by_cases hSeparation :
                ...
                · rcases
                  ...
                  · have hRowNe :
                    ...
                    exact hRejectOfConditionNeg <| by
                      simpa [fs_zfc_object_certificate_verifier] using
                        fs_zfc_support_raw_object_certificate_condition_neg_of_separation_generate
                          (ProofT.ZFC.proof_sequence number ·ₘ
                            numₘ(index))
                          certificateCode candidate
                          hFormulaAdmissible hFormulaClosed
                ...
                by_cases hCollection :
                    (godel_unpair_value
                      (godel_unpair_value certificateCode).2).1 = 1
                · rcases
                      fs_zfc_support_generate_none_or_formula_ne_of_verifier_false
                        hCheck with
                    hGenerate | ⟨candidate, hGenerate, hDifferent⟩
                  · exact hRejectOfConditionNeg <| by
                      simpa [fs_zfc_object_certificate_verifier] using
                        fs_zfc_support_raw_object_certificate_condition_neg_of_collection_generate_none
                          ...
                          certificateCode
                          hFormulaAdmissible hFormulaClosed
                          hGenerate hOuterOne hCollection
                  · have hRowNe :
                        Derives fs_zfc_support_raw_theory [] (
                          ¬ₘ (standard_token_sequence row ≐ₘ
                            fs_zfc_formula_code_term candidate)) :=
                    ...
                    exact hRejectOfConditionNeg <| by
                      simpa [fs_zfc_object_certificate_verifier] using
                        fs_zfc_support_raw_object_certificate_condition_neg_of_collection_generate
                          (ProofT.ZFC.proof_sequence number ·ₘ
                            numₘ(index))
                          certificateCode candidate
                          hFormulaAdmissible hFormulaClosed
                          hGenerate hFormulaNe
                          hOuterOne hCollection
                · exact hRejectOfConditionNeg <| by
                    simpa [fs_zfc_object_certificate_verifier] using
                      fs_zfc_support_raw_object_certificate_condition_neg_of_unknown_schema_tag
                        (ProofT.ZFC.proof_sequence number ·ₘ
                          numₘ(index))
                        certificateCode hFormulaAdmissible hFormulaClosed
                        hOuterOne hSeparation hCollection
              by_cases hOuterTwo :
                  (godel_unpair_value certificateCode).1 = 2
              · exact hRejectFixed <|
              ...
              · exact hRejectOfConditionNeg <| by
                  simpa [fs_zfc_object_certificate_verifier] using
                    fs_zfc_support_raw_object_certificate_condition_neg_of_unknown_outer_tag
                      (ProofT.ZFC.proof_sequence number ·ₘ
                        numₘ(index))
                      certificateCode hFormulaAdmissible hFormulaClosed
                ...
                have hGroundNeg :
                    Derives fs_zfc_support_raw_theory [] (
                      ¬ₘ modus_ponensₘ(
                        ...
                        ProofT.ZFC.proof_sequence number ·ₘ
                          numₘ(index))) := by
                  simpa [ProofT.ZFC.proof_sequence, rawRows] using
                ...
                have hLineNeg :
                    Derives fs_zfc_support_raw_theory [] (
                      ¬ₘ ProofT.ZFC.line_instance
                        ...
                        (ProofT.ZFC.certificate_sequence number)
                        index) :=
                  ProofT.ZFC.line_instance_neg_of_modus_ponens_order
                    ProofT.ZFC.certificate_core
                    (ProofT.ZFC.proof_sequence number)
                    (ProofT.ZFC.certificate_sequence number)
                    index implicationIndex premiseIndex
